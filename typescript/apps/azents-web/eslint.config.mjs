...
export default defineConfig([
  ...
  tseslint.configs.recommendedTypeChecked,
  {
    ...
    rules: {
      ...
      // Enforce imports between architectural layers.
  ...
  // Disallow process.env access outside the config boundary.
  {
    files: ["**/*.ts", "**/*.tsx"],
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "Do not access process.env directly. Use getServerConfig(), getPublicConfig(), or useConfig() from @/config.",
        },
      ],
    },
  },
  // Disallow NEXT_PUBLIC_ variables in favor of server-side configuration.
  {
    files: ["**/*.ts", "**/*.tsx"],
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "Do not use NEXT_PUBLIC_ environment variables. Use server-side configuration and pass client values through ConfigProvider.",
        },
        {
          selector:
