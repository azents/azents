...
const meta = {
  component: XaiOAuthConnectionCard,
  args: {
    canManage: true,
    state: { type: "IDLE" },
    starting: false,
...
} satisfies Meta<typeof XaiOAuthConnectionCard>;
...
export const Reauthenticate = {
  args: { integrationId: "xai-existing" },
...
export const Pending = {
  ...
  play: async ({ args, canvasElement }) => {
    ...
    await expect(
      canvas.getByRole("link", { name: "Open xAI verification page" }),
    ).toHaveAttribute("href", "https://accounts.x.ai/activate");
