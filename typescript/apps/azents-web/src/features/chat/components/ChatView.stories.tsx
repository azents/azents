...
const workspacePanel: WorkspacePanelContainerOutput = {
  ...
  worktreeSourceProjectPath: null,
  worktreeStartingRef: null,
  worktreeRefOptions: [],
  isLoadingWorktreeRefs: false,
  worktreeRefError: null,
  isAttachingWorktreeProject: false,
  attachWorktreeProjectError: null,
  onOpenWorktreeSourcePicker: noop,
  onSetWorktreeStartingRef: noop,
  onAttachWorktreeProject: noop,
  onCancelWorktreeProjectAttach: noop,
