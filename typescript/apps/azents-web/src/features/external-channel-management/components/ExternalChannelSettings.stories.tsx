...
const meta = {
  ...
  args: {
    ...
    discordThreadDurationSavedConnectionId: null,
    discordUrlPreviewDrafts: {},
    discordUrlPreviewSavedConnectionId: null,
    defaultResponseMode: "all_messages",
    ...
    onDiscordUrlPreviewChange: noop,
    onSaveDiscordUrlPreview: noop,
    onRevokeGrant: noop,
    onRemoveBlock: noop,
  },
