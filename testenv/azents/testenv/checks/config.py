...
_REQUIRED_VARS = (
    ...
    "AZ_RUNTIME_TRANSFER_COORDINATOR_ALLOW_INSECURE",
    "AZ_RUNTIME_CONTROL_PORT",
    "AZ_RUNTIME_CONTROL_ALLOW_INSECURE",
    "AZ_RUNTIME_CONTROL_WORKSPACE_S3_BUCKET",
    "AZ_RUNTIME_CONTROL_WORKSPACE_S3_ENDPOINT_URL",
    "AZ_RUNTIME_CONTROL_WORKSPACE_S3_ACCESS_KEY_ID",
    "AZ_RUNTIME_CONTROL_WORKSPACE_S3_SECRET_ACCESS_KEY",
    "AZ_RUNTIME_RUNNER_IMAGE",
    "AZ_RUNTIME_RUNNER_CONTROL_ENDPOINT",
    "AZ_RUNTIME_RUNNER_TRANSFER_ENDPOINT",
)
