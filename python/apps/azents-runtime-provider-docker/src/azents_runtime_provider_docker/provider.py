...
_CONTAINED_CAP_ADD = ("SETUID", "SETGID", "SETFCAP", "SYS_ADMIN")
    ...
    def _container_spec(
        ...
        *,
        ...
        return DockerContainerSpec(
            ...
            user=_CONTAINED_RUNNER_USER if contained else _RUNNER_USER,
...
def _validate_process_containment(
    ...
    if (
        not value.security_profile.strip()
        or value.security_profile != value.security_profile.strip()
    ):
        raise ValueError("Docker process containment security profile is invalid.")
    if (
