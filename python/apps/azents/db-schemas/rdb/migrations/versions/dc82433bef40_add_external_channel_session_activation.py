"""Add durable External Channel Session activation."""
...
revision: str = "dc82433bef40"
down_revision: str | Sequence[str] | None = "a3a7d36f4416"
...
def upgrade() -> None:
    """Add durable ordered External Channel Session activation state."""
...
def downgrade() -> None:
    """Remove durable External Channel Session activation state."""
    op.drop_table("external_channel_session_activation_deliveries")
    op.drop_index(
        "uq_external_channel_session_activations_position_barrier",
        table_name="external_channel_session_activations",
    )
    op.drop_index(
        "ix_external_channel_session_activations_binding_id",
        table_name="external_channel_session_activations",
