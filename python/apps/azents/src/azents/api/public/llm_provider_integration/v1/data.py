...
class SubscriptionUsageLimitResponse(BaseModel):
    ...
    def convert_from(
        ...
        return cls(
            ...
            resets_at=(
                _ensure_timezone_aware_datetime(data.resets_at)
...
class ChatGPTSubscriptionFinancialDetailsResponse(BaseModel):
    ...
    def convert_from(
        ...
        return cls(
            ...
            spend_resets_at=(
                _ensure_timezone_aware_datetime(data.spend_resets_at)
...
class SubscriptionUsageAvailableResponse(BaseModel):
    ...
    def convert_from(
        ...
        return cls(
            ...
            fetched_at=_ensure_timezone_aware_datetime(data.fetched_at),
...
def _ensure_timezone_aware_datetime(value: datetime.datetime) -> datetime.datetime:
    """Interpret naive subscription timestamps as UTC without changing offsets."""
