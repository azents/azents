...
class ToolkitProvider(ABC, Generic[ConfigT]):
    ...
    def validate_config(cls, data: dict[str, object]) -> ConfigT:
        ...
        """
        return cls.config_model.model_validate(data)  # ty: ignore[invalid-return-type] — TypeVar/ClassVar relation is guaranteed by each concrete ToolkitProvider subclass.  # noqa: E501
