    ...
    def _build(
        ...
        *,
        ...
        return ExchangeFile(
            ...
            sha256=rdb.sha256,
            provenance_kind=rdb.provenance_kind,
            source_user_id=rdb.source_user_id,
            source_agent_id=rdb.source_agent_id,
            source_run_id=rdb.source_run_id,
            source_tool_name=rdb.source_tool_name,
            source_provider=rdb.source_provider,
            source_exchange_file_id=rdb.source_exchange_file_id,
