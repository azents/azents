"""Completed database operations for ChatGPT device OAuth sessions."""
...
class ChatGPTOAuthOperations:
    ...
    def __init__(
        ...
        session_repository: Annotated[
            ChatGPTOAuthSessionRepository, Depends(_get_session_repository)
        ],
    ...
    async def valid_target(self, *, workspace_id: str, integration_id: str) -> bool:
        ...
        async with self.session_manager() as session:
            ...
            return (
                ...
                and target.provider == LLMProvider.CHATGPT_OAUTH
            )

    async def create_session(
        self, create: ChatGPTOAuthSessionCreate
    ) -> ChatGPTOAuthSession:
            ...
            if target is None:
                ...
                match updated:
                    ...
                    case Failure():
                        ...
                        raise RuntimeError("Locked ChatGPT integration update failed")
                    case _:
