...
with azentsadminclient.ApiClient(configuration) as api_client:
    ...
    try:
        # List Contracts
        api_response = api_instance.runtime_provider_v1_list_contracts(provider_id)
        print("The response of RuntimeProviderV1Api->runtime_provider_v1_list_contracts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RuntimeProviderV1Api->runtime_provider_v1_list_contracts: %s\n" % e)
```
