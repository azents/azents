...
class RuntimeInfrastructureProfileDeleteResponse(BaseModel):
    ...
    skipped_recreation_item_count: Annotated[int, Field(strict=True, ge=0)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["profile_id", "superseded_recreation_operation_count", "skipped_recreation_item_count"]
