...
class EmailVerificationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Verification ID (UUID7 hex)")
    email: StrictStr = Field(description="Email address")
    code: StrictStr = Field(description="Six-digit verification code")
    csrf_token: StrictStr = Field(description="CSRF token")
    expires_at: datetime = Field(description="Expiration time")
    verified_at: Optional[datetime] = None
    created_at: datetime = Field(description="Created time")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "email", "code", "csrf_token", "expires_at", "verified_at", "created_at"]
