...
class SystemSettingVersionConflictDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "message", "current_version"]

    @field_validator('code')
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['stale_system_setting_version']):
            raise ValueError("must be one of enum values ('stale_system_setting_version')")
        return value
