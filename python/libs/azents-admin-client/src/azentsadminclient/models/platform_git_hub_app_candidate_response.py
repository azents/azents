...
class PlatformGitHubAppCandidateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "base_version", "validation_status", "validation_code", "validation_message", "action_hint", "impact", "created_at", "updated_at", "expires_at"]
