...
class SystemUserRoleAssignmentListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[SystemUserRoleAssignmentResponse] = Field(description="System role assignments")
    total: StrictInt = Field(description="Total assignment count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SystemUserRoleAssignmentResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
