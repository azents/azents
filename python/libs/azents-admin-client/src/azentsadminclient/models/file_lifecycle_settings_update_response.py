...
class FileLifecycleSettingsUpdateResponse(BaseModel):
    ...
    application: Optional[ArchiveRetentionApplicationResponse]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["settings", "application"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": FileLifecycleSettingsResponse.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
            "application": ArchiveRetentionApplicationResponse.from_dict(obj["application"]) if obj.get("application") is not None else None
        })
