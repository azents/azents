...
class PasswordResetTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Password reset token ID")
    user_id: StrictStr = Field(description="Reset target User ID")
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "created_by_user_id", "expires_at", "used_at", "revoked_at", "created_at", "updated_at"]
