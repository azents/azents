...
class RuntimeRecreationOperationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "target_kind", "target_id", "target_version", "status", "concurrency_limit", "total_count", "pending_count", "running_count", "succeeded_count", "skipped_count", "failed_count", "created_at", "started_at", "completed_at", "items"]
