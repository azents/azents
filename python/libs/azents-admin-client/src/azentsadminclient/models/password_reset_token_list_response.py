...
class PasswordResetTokenListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[PasswordResetTokenResponse] = Field(description="Password reset token list")
    total: StrictInt = Field(description="Total record count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PasswordResetTokenResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
