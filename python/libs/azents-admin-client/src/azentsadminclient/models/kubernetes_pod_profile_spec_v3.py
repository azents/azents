...
class KubernetesPodProfileSpecV3(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of network_access
        if self.network_access:
            _dict['network_access'] = self.network_access.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "network_access": RuntimeNetworkAccess.from_dict(obj["network_access"]) if obj.get("network_access") is not None else None,
