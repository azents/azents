...
class ArchiveRetentionPreviewResponse(BaseModel):
    """
    Existing archive impact preview response.
    """ # noqa: E501
    affected_count: Annotated[int, Field(strict=True, ge=0)]
    immediately_eligible_count: Annotated[int, Field(strict=True, ge=0)]
    cancelled_count: Annotated[int, Field(strict=True, ge=0)]
    scheduled_count: Annotated[int, Field(strict=True, ge=0)]
    excluded_count: Annotated[int, Field(strict=True, ge=0)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["affected_count", "immediately_eligible_count", "cancelled_count", "scheduled_count", "excluded_count"]
