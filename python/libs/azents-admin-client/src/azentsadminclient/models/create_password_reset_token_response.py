...
class CreatePasswordResetTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    token: PasswordResetTokenResponse = Field(description="Password reset token metadata")
    plaintext_token: StrictStr = Field(description="Plaintext password reset token")
    reset_url: StrictStr = Field(description="Password reset URL")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["token", "plaintext_token", "reset_url"]
