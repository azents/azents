...
class ChatV1Api:
    ...
    @validate_call
    def chat_v1_attach_session_git_worktree(
        self,
        agent_id: StrictStr,
        session_id: StrictStr,
        session_git_worktree_attach_request: SessionGitWorktreeAttachRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param session_id: (required)
        :type session_id: str
        :param session_git_worktree_attach_request: (required)
        :type session_git_worktree_attach_request: SessionGitWorktreeAttachRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._chat_v1_attach_session_git_worktree_serialize(
            agent_id=agent_id,
            session_id=session_id,
            session_git_worktree_attach_request=session_git_worktree_attach_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SessionGitWorktreeAttachResponse",
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def chat_v1_attach_session_git_worktree_with_http_info(
        self,
        agent_id: StrictStr,
        session_id: StrictStr,
        session_git_worktree_attach_request: SessionGitWorktreeAttachRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SessionGitWorktreeAttachResponse]:
        """Attach Session Git Worktree
    ...
    @validate_call
    def chat_v1_attach_session_git_worktree_without_preload_content(
        self,
        agent_id: StrictStr,
        session_id: StrictStr,
        session_git_worktree_attach_request: SessionGitWorktreeAttachRequest,
    ...
    def _chat_v1_attach_session_git_worktree_serialize(
        self,
        agent_id,
        session_id,
        session_git_worktree_attach_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if session_git_worktree_attach_request is not None:
            _body_params = session_git_worktree_attach_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/chat/v1/agents/{agent_id}/sessions/{session_id}/git-worktrees',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
