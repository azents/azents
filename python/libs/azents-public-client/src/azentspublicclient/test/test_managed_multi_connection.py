...
class TestManagedMultiConnection(unittest.TestCase):
    """ManagedMultiConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedMultiConnection:
        """Test ManagedMultiConnection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedMultiConnection`
        """
        model = ManagedMultiConnection()
        if include_optional:
    ...
    def testManagedMultiConnection(self):
        """Test ManagedMultiConnection"""
