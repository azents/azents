...
class TestSessionInitializationResponse(unittest.TestCase):
    """SessionInitializationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionInitializationResponse:
        """Test SessionInitializationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionInitializationResponse`
        """
        model = SessionInitializationResponse()
        if include_optional:
    ...
    def testSessionInitializationResponse(self):
        """Test SessionInitializationResponse"""
