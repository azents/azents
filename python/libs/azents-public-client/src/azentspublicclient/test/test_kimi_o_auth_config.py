...
class TestKimiOAuthConfig(unittest.TestCase):
    """KimiOAuthConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KimiOAuthConfig:
        """Test KimiOAuthConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KimiOAuthConfig`
        """
        model = KimiOAuthConfig()
        if include_optional:
