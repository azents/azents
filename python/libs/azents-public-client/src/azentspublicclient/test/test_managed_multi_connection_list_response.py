...
class TestManagedMultiConnectionListResponse(unittest.TestCase):
    """ManagedMultiConnectionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedMultiConnectionListResponse:
        """Test ManagedMultiConnectionListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedMultiConnectionListResponse`
        """
        model = ManagedMultiConnectionListResponse()
        if include_optional:
    ...
    def testManagedMultiConnectionListResponse(self):
        """Test ManagedMultiConnectionListResponse"""
