...
class TestRuntimeConfigurationStateResponse(unittest.TestCase):
    """RuntimeConfigurationStateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RuntimeConfigurationStateResponse:
        """Test RuntimeConfigurationStateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RuntimeConfigurationStateResponse`
        """
        model = RuntimeConfigurationStateResponse()
        if include_optional:
            return RuntimeConfigurationStateResponse(
                sequence = 56,
                status = 'unconfigured',
    ...
    def testRuntimeConfigurationStateResponse(self):
        """Test RuntimeConfigurationStateResponse"""
