...
class AgentWorkspaceReadyAccessResponse(BaseModel):
    ...
    manifest: AgentWorkspaceManifestResponse = Field(description="Agent Workspace manifest")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "manifest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "manifest": AgentWorkspaceManifestResponse.from_dict(obj["manifest"]) if obj.get("manifest") is not None else None
        })
