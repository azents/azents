...
class ExternalChannelCredentialSnapshot(BaseModel):
    ...
    configured_fields: List[StrictStr] = Field(description="Configured secret field names without secret values")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["provider", "configured_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configured_fields": obj.get("configured_fields")
        })
