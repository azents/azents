...
class KubernetesToleration(BaseModel):
    ...
    """ # noqa: E501
    key: Annotated[str, Field(min_length=1, strict=True, max_length=253)]
    operator: StrictStr
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if self.toleration_seconds is None and "toleration_seconds" in self.model_fields_set:
            _dict['toleration_seconds'] = None
