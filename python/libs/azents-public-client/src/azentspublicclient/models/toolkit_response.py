...
class ToolkitResponse(BaseModel):
    ...
    """ # noqa: E501
    slug: StrictStr = Field(description="Tool slug")
    ...
    system_prompt: StrictStr = Field(description="Definition-level system prompt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["slug", "name", "description", "config_schema", "system_prompt"]
