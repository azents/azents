...
class AgentWorkspaceMoveResponse(BaseModel):
    ...
    """ # noqa: E501
    source_path: StrictStr = Field(description="Moved source path")
    destination_path: StrictStr = Field(description="Move destination path")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["source_path", "destination_path"]
