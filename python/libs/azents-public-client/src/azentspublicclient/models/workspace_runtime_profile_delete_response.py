...
class WorkspaceRuntimeProfileDeleteResponse(BaseModel):
    ...
    cleared_workspace_default: StrictBool
    cleared_agent_count: Annotated[int, Field(strict=True, ge=0)]
    affected_running_runtime_count: Annotated[int, Field(strict=True, ge=0)]
    superseded_recreation_operation_count: Annotated[int, Field(strict=True, ge=0)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["profile_id", "cleared_workspace_default", "cleared_agent_count", "affected_running_runtime_count", "superseded_recreation_operation_count"]
