...
class PendingMailboxEnvelope(BaseModel):
    ...
    kind: StrictStr
    scheduling_mode: StrictStr
    created_at: datetime
    items: Annotated[List[PendingMailboxItem], Field(min_length=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mailbox_item_id", "session_id", "kind", "scheduling_mode", "created_at", "items"]
