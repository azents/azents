...
class AgentWorkspaceManifestResponse(BaseModel):
    ...
    """ # noqa: E501
    root: StrictStr = Field(description="Agent Workspace root")
    cwd: StrictStr = Field(description="Initial working directory")
    entries: List[AgentWorkspaceEntryResponse] = Field(description="Root entry list")
    git: Optional[Dict[str, Any]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["root", "cwd", "entries", "git"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": obj.get("root"),
            "cwd": obj.get("cwd"),
            "entries": [AgentWorkspaceEntryResponse.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "git": obj.get("git")
        })
