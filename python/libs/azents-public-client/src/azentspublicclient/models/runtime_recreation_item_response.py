...
class RuntimeRecreationItemResponse(BaseModel):
    ...
    attempt: StrictInt
    dispatched_generation: Optional[StrictInt]
    failure_code: Optional[StrictStr]
    failure_message: Optional[StrictStr]
    updated_at: datetime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["runtime_id", "status", "attempt", "dispatched_generation", "failure_code", "failure_message", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if dispatched_generation (nullable) is None
        # and model_fields_set contains the field
        if self.dispatched_generation is None and "dispatched_generation" in self.model_fields_set:
            _dict['dispatched_generation'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dispatched_generation": obj.get("dispatched_generation"),
