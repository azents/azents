...
class RuntimeExecutionReduction(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["path", "previous", "current", "governing_layer", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "governing_layer": obj.get("governing_layer"),
