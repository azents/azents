...
class AgentSessionUnreadTerminalRunAcknowledgeRequest(BaseModel):
    ...
    """ # noqa: E501
    through_run_id: StrictStr = Field(description="Observed terminal AgentRun ID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["through_run_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "through_run_id": obj.get("through_run_id")
        })
