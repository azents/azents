...
class UploadedImage(BaseModel):
    ...
    """ # noqa: E501
    filename: StrictStr = Field(description="Original upload filename")
    ...
    uploaded_at: datetime = Field(description="Upload completion time (ISO 8601, tz-aware)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["filename", "default", "thumbnails", "uploaded_at"]
