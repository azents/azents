...
class AgentRuntimeRemovalImpactResponse(BaseModel):
    ...
    """ # noqa: E501
    active_root_session_count: StrictInt
    active_subagent_count: StrictInt
    active_run_count: StrictInt
    queued_runtime_action_count: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["active_root_session_count", "active_subagent_count", "active_run_count", "queued_runtime_action_count"]
