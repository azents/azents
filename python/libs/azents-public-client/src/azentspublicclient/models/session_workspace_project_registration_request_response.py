...
class SessionWorkspaceProjectRegistrationRequestResponse(BaseModel):
    ...
    path: StrictStr = Field(description="Requested Project path")
    reason: StrictStr = Field(description="Request reason provided by the Agent")
    status: StrictStr = Field(description="Request status")
    project_id: Optional[StrictStr] = None
    created_at: datetime = Field(description="Created time")
    updated_at: datetime = Field(description="Updated time")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "path", "reason", "status", "project_id", "created_at", "updated_at"]
