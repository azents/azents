...
class RuntimeNetworkPolicyModule(BaseModel):
    """
    Typed customer-traffic network boundary.
    """ # noqa: E501
    allowed_cidrs: Optional[List[StrictStr]] = None
    denied_cidrs: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["allowed_cidrs", "denied_cidrs"]
