...
class SessionGitWorktreeAttachResponse(BaseModel):
    ...
    """ # noqa: E501
    worktree_id: StrictStr = Field(description="Queued SessionGitWorktree ID")
    initialization: SessionInitializationResponse = Field(description="Updated session initialization projection")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["worktree_id", "initialization"]
