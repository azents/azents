...
class SetupStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    platform_linked: StrictBool = Field(description="Whether platform account is linked")
    pat_registered: StrictBool = Field(description="Whether PAT is registered")
    github_username: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["platform_linked", "pat_registered", "github_username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "platform_linked": obj.get("platform_linked"),
            "pat_registered": obj.get("pat_registered"),
