...
class AgentWorkspaceBulkDeleteRequest(BaseModel):
    ...
    """ # noqa: E501
    paths: List[StrictStr] = Field(description="File or directory paths to delete")
    recursive: Optional[StrictBool] = Field(default=False, description="Delete directories recursively")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["paths", "recursive"]
