...
class MultiChannelDefaultRequest(BaseModel):
    """
    MultiChannelDefaultRequest
    """ # noqa: E501
    expected_generation: datetime
    route_id: Annotated[str, Field(min_length=1, strict=True, max_length=32)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expected_generation", "route_id"]
