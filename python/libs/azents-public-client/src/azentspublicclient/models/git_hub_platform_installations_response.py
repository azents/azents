...
class GitHubPlatformInstallationsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["installations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "installations": [GitHubInstallationItem.from_dict(_item) for _item in obj["installations"]] if obj.get("installations") is not None else None
        })
