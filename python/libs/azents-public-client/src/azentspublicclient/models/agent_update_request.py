...
class AgentUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "model_selection", "lightweight_model_selection", "selectable_model_options", "main_model_label", "lightweight_model_label", "model_parameters", "system_prompt", "enabled", "type", "runtime_profile_id", "expected_runtime_profile_selection_version", "terminal_enabled", "memory_enabled", "tool_search_enabled", "max_turns", "auto_archive_ttl_days", "subagent_settings"]
