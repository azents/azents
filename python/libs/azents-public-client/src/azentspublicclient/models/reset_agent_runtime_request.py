...
class ResetAgentRuntimeRequest(BaseModel):
    ...
    """ # noqa: E501
    final_desired_state: RuntimeDesiredState = Field(description="Desired state after reset completes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["final_desired_state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "final_desired_state": obj.get("final_desired_state")
        })
