...
class AgentRuntimeSystemMetricCurrentResponse(BaseModel):
    ...
    used: Optional[StrictInt]
    total: Optional[StrictInt]
    percentage: Optional[Union[StrictFloat, StrictInt]]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["state", "measured_at", "used", "total", "percentage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if measured_at (nullable) is None
        # and model_fields_set contains the field
        if self.measured_at is None and "measured_at" in self.model_fields_set:
            _dict['measured_at'] = None
