...
class RuntimeWebUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["expected_revision", "label", "selected_duration_seconds", "operation_key"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.selected_duration_seconds is None and "selected_duration_seconds" in self.model_fields_set:
            _dict['selected_duration_seconds'] = None
