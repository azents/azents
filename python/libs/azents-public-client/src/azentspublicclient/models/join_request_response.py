...
class JoinRequestResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Join request ID")
    workspace_id: StrictStr = Field(description="Workspace ID")
    user_id: StrictStr = Field(description="Requesting user ID")
    message: Optional[StrictStr]
    status: JoinRequestStatus = Field(description="Request status")
    created_at: datetime = Field(description="Created time")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "workspace_id", "user_id", "message", "status", "created_at"]
