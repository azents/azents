...
class AgentSubagentUpdateRequest(BaseModel):
    """
    AgentSubagent update request, for partial updates.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description exposed to LLM")
    enabled: Optional[StrictBool] = Field(default=None, description="Enabled flag")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["description", "enabled"]
