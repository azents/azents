...
class InvitationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="WorkspaceInvitation ID (UUID7 hex)")
    workspace_id: StrictStr = Field(description="Workspace ID")
    email: StrictStr = Field(description="Invitation target email")
    role: WorkspaceUserRole = Field(description="Invitation role")
    invited_by: StrictStr = Field(description="Inviting WorkspaceUser ID")
    status: InvitationStatus = Field(description="Invitation status")
    created_at: datetime = Field(description="Created time")
    updated_at: datetime = Field(description="Updated time")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "workspace_id", "email", "role", "invited_by", "status", "created_at", "updated_at"]
