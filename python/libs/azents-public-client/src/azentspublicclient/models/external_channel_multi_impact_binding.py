...
class ExternalChannelMultiImpactBinding(BaseModel):
    """
    ...
    channel_label: StrictStr
    thread_label: Optional[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "route_id", "agent_session_id", "resource_id", "channel_label", "thread_label"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if thread_label (nullable) is None
        # and model_fields_set contains the field
        if self.thread_label is None and "thread_label" in self.model_fields_set:
            _dict['thread_label'] = None
