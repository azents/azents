...
class CommandAction(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = 'command'
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Command name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'command',
            "name": obj.get("name")
        })
