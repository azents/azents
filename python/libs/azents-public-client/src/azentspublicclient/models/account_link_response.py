...
class AccountLinkResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "workspace_id", "workspace_name", "workspace_handle", "provider", "identity_scope", "provider_tenant_display_label", "provider_display_label", "linked_at", "state"]
