...
class AgentSubagentCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    subagent_id: StrictStr = Field(description="Subagent ID to link")
    description: StrictStr = Field(description="Description exposed to the LLM")
    enabled: Optional[StrictBool] = Field(default=True, description="Enabled state")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["subagent_id", "description", "enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subagent_id": obj.get("subagent_id"),
