...
class InputActionAttachmentPolicyResponse(BaseModel):
    ...
    """ # noqa: E501
    policy: StrictStr = Field(description="Attachment policy")
    ...
    def policy_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unsupported', 'optional', 'required']):
            raise ValueError("must be one of enum values ('unsupported', 'optional', 'required')")
        return value
