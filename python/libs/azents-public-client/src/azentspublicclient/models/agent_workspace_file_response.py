...
class AgentWorkspaceFileResponse(BaseModel):
    ...
    media_type: StrictStr = Field(description="MIME type")
    size: StrictInt = Field(description="File size")
    text: Optional[StrictStr] = None
    truncated: StrictBool = Field(description="Whether preview was truncated")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "path", "media_type", "size", "text", "truncated"]
