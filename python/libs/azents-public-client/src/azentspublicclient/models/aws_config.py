...
class AwsConfig(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = 'aws_credentials'
    access_key_id: StrictStr = Field(description="AWS Access Key ID")
    region: StrictStr = Field(description="AWS region")
    role_arn: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "access_key_id", "region", "role_arn"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['aws_credentials']):
            raise ValueError("must be one of enum values ('aws_credentials')")
        return value
