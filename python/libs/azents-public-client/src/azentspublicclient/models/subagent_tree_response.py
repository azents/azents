...
class SubagentTreeResponse(BaseModel):
    ...
    """ # noqa: E501
    root_session_agent_id: StrictStr = Field(description="Root SessionAgent ID")
    root_agent_session_id: StrictStr = Field(description="Root AgentSession ID")
    current_session_agent_id: StrictStr = Field(description="Current SessionAgent ID")
    nodes: List[SubagentTreeNodeResponse] = Field(description="Root tree nodes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["root_session_agent_id", "root_agent_session_id", "current_session_agent_id", "nodes"]
