...
class AgentWorkspaceBulkMoveRequest(BaseModel):
    ...
    """ # noqa: E501
    source_paths: List[StrictStr] = Field(description="Source paths")
    destination_directory: StrictStr = Field(description="Destination directory")
    overwrite: Optional[StrictBool] = Field(default=False, description="Overwrite existing destinations")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["source_paths", "destination_directory", "overwrite"]
