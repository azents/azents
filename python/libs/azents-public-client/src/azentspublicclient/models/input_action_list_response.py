...
class InputActionListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[InputActionDefinitionResponse] = Field(description="Available composer action definitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InputActionDefinitionResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
