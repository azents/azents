...
class SessionWorkspaceProjectRegistrationRequestListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[SessionWorkspaceProjectRegistrationRequestResponse] = Field(description="Project registration request list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SessionWorkspaceProjectRegistrationRequestResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
