...
class ExternalChannelProviderIdentity(BaseModel):
    """
    ...
    app_id: StrictStr
    tenant_id: StrictStr
    bot_user_id: Optional[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["provider", "app_id", "tenant_id", "bot_user_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if bot_user_id (nullable) is None
        # and model_fields_set contains the field
        if self.bot_user_id is None and "bot_user_id" in self.model_fields_set:
            _dict['bot_user_id'] = None
