...
class SlackConnectionCredentials(BaseModel):
    ...
    bot_token: StrictStr = Field(description="Slack bot user OAuth token")
    signing_secret: StrictStr = Field(description="Slack request signing secret")
    app_token: Optional[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["provider", "bot_token", "signing_secret", "app_token"]
