...
class ChatStoppedRunRetryRequest(BaseModel):
    ...
    stopped_run_id: StrictStr = Field(description="Recoverable stopped AgentRun ID")
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "stopped_run_id", "client_request_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stopped_run_id": obj.get("stopped_run_id"),
