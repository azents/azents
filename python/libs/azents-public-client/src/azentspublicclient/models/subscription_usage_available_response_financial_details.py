...
class SubscriptionUsageAvailableResponseFinancialDetails(BaseModel):
    ...
    """
    # data type: ChatGPTSubscriptionFinancialDetailsResponse
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        instance = SubscriptionUsageAvailableResponseFinancialDetails.model_construct()
        error_messages = []
        match = 0
        # validate data type: ChatGPTSubscriptionFinancialDetailsResponse
        if not isinstance(v, ChatGPTSubscriptionFinancialDetailsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ChatGPTSubscriptionFinancialDetailsResponse`")
        else:
            match += 1
        # validate data type: XaiSubscriptionFinancialDetailsResponse
        if not isinstance(v, XaiSubscriptionFinancialDetailsResponse):
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        # deserialize data into ChatGPTSubscriptionFinancialDetailsResponse
        try:
            instance.actual_instance = ChatGPTSubscriptionFinancialDetailsResponse.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into XaiSubscriptionFinancialDetailsResponse
        try:
            instance.actual_instance = XaiSubscriptionFinancialDetailsResponse.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
