...
class BootstrapFirstOwnerRequest(BaseModel):
    """
    First owner bootstrap request.
    """ # noqa: E501
    email: StrictStr = Field(description="Owner email")
    password: StrictStr = Field(description="Owner initial password")
    ...
    __properties: ClassVar[List[str]] = ["email", "password", "owner_name", "workspace_name", "workspace_handle", "locale"]
