...
class PendingMailboxScheduledTaskPresentation(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scheduled_task_trigger', 'scheduled_task_continuation']):
            raise ValueError("must be one of enum values ('scheduled_task_trigger', 'scheduled_task_continuation')")
        return value
