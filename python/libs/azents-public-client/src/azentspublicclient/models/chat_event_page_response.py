...
class ChatEventPageResponse(BaseModel):
    ...
    has_more: StrictBool = Field(description="Whether older events exist")
    has_newer: Optional[StrictBool] = Field(default=False, description="Whether newer events exist")
    next_cursor: Optional[StrictStr] = None
    previous_cursor: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["items", "has_more", "has_newer", "next_cursor", "previous_cursor"]
