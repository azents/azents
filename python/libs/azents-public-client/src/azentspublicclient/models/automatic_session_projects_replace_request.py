...
class AutomaticSessionProjectsReplaceRequest(BaseModel):
    ...
    """ # noqa: E501
    expected_revision: Annotated[int, Field(strict=True, ge=1)] = Field(description="Revision that must match before replacing the policy")
    project_paths: List[StrictStr] = Field(description="Ordered existing Project paths; empty clears the policy")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expected_revision", "project_paths"]
