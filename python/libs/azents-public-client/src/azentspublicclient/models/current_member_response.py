...
class CurrentMemberResponse(BaseModel):
    ...
    """ # noqa: E501
    workspace_user_id: StrictStr = Field(description="Current user WorkspaceUser ID")
    role: WorkspaceUserRole = Field(description="Current user role")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["workspace_user_id", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspace_user_id": obj.get("workspace_user_id"),
            "role": obj.get("role")
        })
