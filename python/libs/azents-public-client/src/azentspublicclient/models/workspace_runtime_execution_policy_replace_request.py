...
class WorkspaceRuntimeExecutionPolicyReplaceRequest(BaseModel):
    ...
    allowed_profile_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=100)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expected_version", "restriction", "allowed_profile_ids"]
