...
[**user_v1_update_me**](UserV1Api.md#user_v1_update_me) | **PATCH** /user/v1/me | Update Me
...
# **user_v1_update_me**
> MeResponse user_v1_update_me(update_my_user_request)
...
with azentspublicclient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = azentspublicclient.UserV1Api(api_client)
    update_my_user_request = azentspublicclient.UpdateMyUserRequest() # UpdateMyUserRequest | 

    try:
        # Update Me
        api_response = api_instance.user_v1_update_me(update_my_user_request)
        print("The response of UserV1Api->user_v1_update_me:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UserV1Api->user_v1_update_me: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **update_my_user_request** | [**UpdateMyUserRequest**](UpdateMyUserRequest.md)|  | 
