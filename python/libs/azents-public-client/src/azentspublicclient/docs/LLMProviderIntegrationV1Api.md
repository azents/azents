...
[**llm_provider_integration_v1_get_image_model_catalog**](LLMProviderIntegrationV1Api.md#llm_provider_integration_v1_get_image_model_catalog) | **GET** /llm-provider-integration/v1/workspaces/{handle}/llm-provider-integrations/{integration_id}/image-generation-model-catalog | Get Image Model Catalog
...
[**llm_provider_integration_v1_sync_image_model_catalog**](LLMProviderIntegrationV1Api.md#llm_provider_integration_v1_sync_image_model_catalog) | **POST** /llm-provider-integration/v1/workspaces/{handle}/llm-provider-integrations/{integration_id}/image-generation-model-catalog-sync | Sync Image Model Catalog
...
# **llm_provider_integration_v1_get_image_model_catalog**
> ImageGenerationModelCatalogResponse llm_provider_integration_v1_get_image_model_catalog(integration_id, handle)
...
with azentspublicclient.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Image Model Catalog
        api_response = api_instance.llm_provider_integration_v1_get_image_model_catalog(integration_id, handle)
        print("The response of LLMProviderIntegrationV1Api->llm_provider_integration_v1_get_image_model_catalog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProviderIntegrationV1Api->llm_provider_integration_v1_get_image_model_catalog: %s\n" % e)
```
...
[**ImageGenerationModelCatalogResponse**](ImageGenerationModelCatalogResponse.md)
...
# **llm_provider_integration_v1_sync_image_model_catalog**
> ModelCatalogSyncResponse llm_provider_integration_v1_sync_image_model_catalog(integration_id, handle)
...
with azentspublicclient.ApiClient(configuration) as api_client:
    ...
    try:
        # Sync Image Model Catalog
        api_response = api_instance.llm_provider_integration_v1_sync_image_model_catalog(integration_id, handle)
        print("The response of LLMProviderIntegrationV1Api->llm_provider_integration_v1_sync_image_model_catalog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProviderIntegrationV1Api->llm_provider_integration_v1_sync_image_model_catalog: %s\n" % e)
```
