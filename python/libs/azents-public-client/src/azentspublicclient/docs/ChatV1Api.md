...
[**chat_v1_retry_stopped_run**](ChatV1Api.md#chat_v1_retry_stopped_run) | **POST** /chat/v1/sessions/{session_id}/retry-stopped-run | Retry Stopped Run
...
# **chat_v1_retry_stopped_run**
> ChatWriteResponse chat_v1_retry_stopped_run(session_id, chat_stopped_run_retry_request)
...
with azentspublicclient.ApiClient(configuration) as api_client:
    ...
    api_instance = azentspublicclient.ChatV1Api(api_client)
    session_id = 'session_id_example' # str | 
    chat_stopped_run_retry_request = azentspublicclient.ChatStoppedRunRetryRequest() # ChatStoppedRunRetryRequest | 

    try:
        # Retry Stopped Run
        api_response = api_instance.chat_v1_retry_stopped_run(session_id, chat_stopped_run_retry_request)
        print("The response of ChatV1Api->chat_v1_retry_stopped_run:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChatV1Api->chat_v1_retry_stopped_run: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **session_id** | **str**|  | 
 **chat_stopped_run_retry_request** | [**ChatStoppedRunRetryRequest**](ChatStoppedRunRetryRequest.md)|  | 
