...
> XaiOAuthDeviceStartResponse xai_oauth_v1_start_device(handle, integration_id=integration_id)
...
with azentspublicclient.ApiClient(configuration) as api_client:
    ...
    try:
        # Start Device
        api_response = api_instance.xai_oauth_v1_start_device(handle, integration_id=integration_id)
