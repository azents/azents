---
title: "Persist Requested and Resolved AgentRun Provenance"
created: 2026-07-10
tags: [architecture, backend, database, observability, routing, historical-reconstruction, migration]
...
# provenance-260710/ADR: Persist Requested and Resolved AgentRun Provenance
...
- Context/token usage can use run-scoped limits under [context-260710/ADR](./context-260710-context-usage-display.md).
- User-message hover/touch details can join requested message intent to actual resolution and retry history under [message-260710/ADR](./message-260710-message-profile-provenance-display.md).
...
- Historical source filename: `0117-agent-run-inference-provenance.md`
