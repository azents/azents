---
title: "ADR-0181: Generalize Client Tool Wire Variant Selection"
created: 2026-07-21
tags: [architecture, backend, engine, llm, tools]
---

# ADR-0181: Generalize Client Tool Wire Variant Selection
...
- ADR-0179 and ADR-0180 remain immutable historical records. This ADR supersedes their preparation
