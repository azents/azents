---
title: "Release and Snapshot Artifact Policy"
created: 2026-06-23
tags: [release, ci-cd, infra, security, historical-reconstruction, migration]
...
# and-260623/ADR: Release and Snapshot Artifact Policy
...
### and-260623/ADR-D1 — Use three artifact channels
...
### and-260623/ADR-D2 — Separate public release packages from private snapshot packages
...
### and-260623/ADR-D3 — Create external releases through a manual release workflow
...
### and-260623/ADR-D4 — Publish internal snapshots from Azents and delegate deployment to a generic downstream repository
...
### and-260623/ADR-D5 — Use SemVer convenience tags for external releases and traceable tags for snapshots
...
### and-260623/ADR-D6 — Publish Helm charts only for external releases
...
### and-260623/ADR-D7 — Keep external artifacts durable and clean up snapshots conservatively
...
### and-260623/ADR-D8 — Require provenance for all pushed images and SBOM for external releases
...
### and-260623/ADR-D9 — Start public releases at v0.1.0 and defer v1.0 criteria
...
- Historical source filename: `0072-release-and-snapshot-artifact-policy.md`
