---
title: "Reuse the Active Run Profile for Matching Inputs"
created: 2026-07-10
tags: [architecture, backend, engine, routing, historical-reconstruction, migration]
...
- Historical source filename: `0118-current-profile-matching-run-join-policy.md`
