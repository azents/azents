---
title: "Select Provider-Specific Tool Dialects for Apply-Patch"
created: 2026-07-21
tags: [architecture, backend, engine, llm, openai, runtime, tools, historical-reconstruction, migration]
...
# patch-260721/ADR: Select Provider-Specific Tool Dialects for Apply-Patch
...
This ADR does not reopen [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-198) decisions about:
...
This ADR may supersede only [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-199) and the model/tool-transport portions of [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-200). Existing durable function-tool calls and results remain valid history.
...
### patch-260721/ADR-D1 — Use a generic plaintext custom tool on verified OpenAI Responses models
...
### patch-260721/ADR-D2 — Separate V4A semantic eligibility from provider tool transport
...
preserves the implemented [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-201) GPT-family compatibility behavior without widening it
...
### patch-260721/ADR-D3 — Persist the originating wire dialect on both call and result
...
### patch-260721/ADR-D4 — Use one exact base-path header before an unchanged V4A body
...
### patch-260721/ADR-D5 — Initially enable custom input only on reviewed official OpenAI API routes
...
### patch-260721/ADR-D6 — Expand full lifecycle compatibility before any production custom write
...
- Historical source filename: `0179-apply-patch-provider-tool-dialects.md`
