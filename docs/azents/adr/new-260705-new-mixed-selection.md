---
title: "New Session Mixed Workspace Selection"
created: 2026-07-05
tags: [architecture, product, backend, frontend, session, workspace, git, historical-reconstruction, migration]
...
# new-260705/ADR: New Session Mixed Workspace Selection
...
[initialization-260703/ADR](./initialization-260703-initialization-lifecycle.md) introduced a durable session initialization lifecycle that gates first-run dispatch while
startup work is pending. [azents-260703/ADR](./azents-260703-azents-git-worktree-ownership-and-cleanup.md) introduced Azents-owned Git worktrees as session-owned generated
...
### new-260705/ADR-D1 — New-session workspace input is an ordered item list
...
### new-260705/ADR-D2 — Existing Project and Worktree are additive item actions
...
### new-260705/ADR-D3 — New-session selector stays compact and follows the existing UI flow
...
### new-260705/ADR-D4 — Default selected workspace comes from the last created session configuration
...
### new-260705/ADR-D5 — Quick-select presets contain only original/source Projects
...
Project Browser visibility as required by [azents-260703/ADR](./azents-260703-azents-git-worktree-ownership-and-cleanup.md), but they do not become reusable new-session
presets/default source paths.

### new-260705/ADR-D6 — Session initialization processes all worktree items before first run
...
### new-260705/ADR-D7 — Worktree identity and cleanup remain separate from Project rows

[azents-260703/ADR](./azents-260703-azents-git-worktree-ownership-and-cleanup.md) remains authoritative: `session_workspace_projects` is only the prompt/tool Project scope,
...
- Historical source filename: `0093-new-session-mixed-workspace-selection.md`
