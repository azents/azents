---
title: "ADR-0074: Primary Agent Sessions and Team-First Multi-Session UX"
created: 2026-06-25
...
### ADR-0074-D1 — Runtime and session are sibling models under Agent
...
### ADR-0074-D2 — Team primary session is the continuity-preserving default
...
### ADR-0074-D3 — Private sessions are target-compatible but implementation-deferred
...
### ADR-0074-D4 — Session list UX is divided into Team and Private sections
...
### ADR-0074-D5 — Selected Web session is route state
...
### ADR-0074-D6 — External routing defaults to primary sessions and hides arbitrary mappings
...
### ADR-0074-D7 — Primary session is not runtime current session
...
### ADR-0074-D8 — Projects are session-owned working context
...
### ADR-0074-D9 — New sessions copy projects from the team primary session
...
### ADR-0074-D10 — Git worktree automation is deferred
...
### ADR-0074-D11 — Primary clear behavior is deferred
