---
title: "ADR-0055: System Prompt Context Inspector Preserves Pre-assembly Fragment Metadata"
created: 2026-06-11
tags: [chat, observability, engine, frontend]
---

# ADR-0055: System Prompt Context Inspector Preserves Pre-assembly Fragment Metadata
...
### ADR-0055-D1: Preserve prompt fragment metadata before final string assembly
...
### ADR-0055-D2: Do not use provider-level toolkit `system_prompt` as runtime prompt evidence
...
### ADR-0055-D3: Exclude toolkit-internal sub-prompt decomposition from this scope
...
### ADR-0055-D4: Expose turn injected prompt as debug event, not primary system prompt navigation
...
### ADR-0055-D5: Show long prompt content through drill-down navigation
