---
title: "ADR-0176: Render Known Tools Through Validated Frontend Adapters"
created: 2026-07-20
tags: [architecture, frontend, chat, tools, ux]
---

# ADR-0176: Render Known Tools Through Validated Frontend Adapters

## Context

ADR-0173 established Generic tool rendering as the permanent compatibility boundary and allowed specialized presentation only for registered tool identities whose payloads validate. ADR-0174 retained that boundary while deferring individual tool detail designs.
