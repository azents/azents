---
title: "Correlate Terminal Run Events by Run ID"
created: 2026-07-12
tags: [architecture, backend, chat, engine, frontend, historical-reconstruction, migration]
...
# terminal-260712/ADR: Correlate Terminal Run Events by Run ID
...
- Historical source filename: `0141-correlate-terminal-run-events.md`
