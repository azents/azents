...
### ADR-0090-D1 — Backend owns the Project browser manifest contract
...
### ADR-0090-D2 — Session Project bindings remain separate from the Agent Project catalog
...
### ADR-0090-D3 — Existing-session and pre-session manifest entrypoints share one entry model
...
### ADR-0090-D4 — Browser manifest reads never block on runtime filesystem checks
...
### ADR-0090-D5 — Project filesystem status is a DB-persisted UI projection
...
### ADR-0090-D6 — Project filesystem status sync runs at meaningful boundaries
...
### ADR-0090-D7 — Frontend renders backend capabilities
