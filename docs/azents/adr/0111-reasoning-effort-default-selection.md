---
title: "ADR-0111: Expose Default as a Reasoning Effort Selection"
created: 2026-07-10
tags: [architecture, agent, frontend, engine]
---

# ADR-0111: Expose Default as a Reasoning Effort Selection
...
The Composer must visibly reflect the resulting selection. This is not run-time fallback: the submitted requested profile contains `null`, and run-time resolution remains strict for every non-null explicit effort under ADR-0105.
