---
title: "ADR-0030: Move LLM Model Catalog to External Sources and Local Overrides"
created: 2026-05-13
tags: [architecture, backend, api, frontend, engine]
---

# ADR-0030: Move LLM Model Catalog to External Sources and Local Overrides

> 📌 **Related design document**: [llm-model-catalog-sync.md](../design/llm-model-catalog-sync.md)
