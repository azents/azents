---
title: "ADR-0028: Split testenv Setup Scenarios and Inject INDEX — Discussion Record"
created: 2026-04-11
tags: [testenv, nointern, harness, scenarios]
---

# ADR-0028: Split testenv Setup Scenarios and Inject INDEX — Discussion Record
