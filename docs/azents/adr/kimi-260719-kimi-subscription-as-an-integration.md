---
title: "Add Kimi Subscription as an Integration-Scoped Provider"
created: 2026-07-19
tags: [architecture, backend, frontend, engine, llm, oauth, billing, security, historical-reconstruction, migration]
...
# kimi-260719/ADR: Add Kimi Subscription as an Integration-Scoped Provider
...
### kimi-260719/ADR-D1. Represent Kimi subscription access as `kimi_oauth`
...
### kimi-260719/ADR-D2. Use the Kimi Code public device client contract
...
### kimi-260719/ADR-D3. Keep a stable per-integration device identity encrypted
...
### kimi-260719/ADR-D4. Use an integration-scoped catalog sourced from Kimi `/models`
...
### kimi-260719/ADR-D5. Reuse the LiteLLM Moonshot runtime route
...
### kimi-260719/ADR-D6. Refresh before runtime and quarantine permanent rejection
...
### kimi-260719/ADR-D7. Add Kimi to normalized subscription usage
...
### kimi-260719/ADR-D8. Exclude Kimi-specific Search and Fetch services
...
- [catalog-260620/ADR](./catalog-260620-catalog-projection-sync.md) remains authoritative for catalog projection and synchronization.
- [failures-260718/ADR](./failures-260718-failures-transparent.md) remains authoritative for model-provider failure classification.
- [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-152) remains authoritative for integration-scoped subscription usage.
- [subscription-260719/ADR](./subscription-260719-subscription-usage-from.md) remains authoritative for selected-composer usage projection.

## Migration provenance

- Historical source filename: `0171-add-kimi-subscription-as-an-integration-scoped-provider.md`
