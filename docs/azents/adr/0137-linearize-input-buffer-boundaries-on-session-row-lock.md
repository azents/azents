---
title: "ADR-0137: Linearize Input Buffer Boundaries on the Session Row Lock"
created: 2026-07-12
tags: [architecture, backend, database, engine, concurrency, session]
---

# ADR-0137: Linearize Input Buffer Boundaries on the Session Row Lock
