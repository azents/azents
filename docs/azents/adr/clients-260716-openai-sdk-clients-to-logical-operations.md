---
title: "Scope OpenAI SDK Clients to Logical Model Operations"
created: 2026-07-16
tags: [architecture, backend, engine, llm, openai, lifecycle, historical-reconstruction, migration]
...
# clients-260716/ADR: Scope OpenAI SDK Clients to Logical Model Operations
...
The client uses the official SDK retry default established by [sdk-260716/ADR](./sdk-260716-openai-sdk-http-retries.md). Continuation state remains separate adapter state but has the same `AgentRunExecution` lifetime as the sampling client.
...
- Historical source filename: `0156-scope-openai-sdk-clients-to-logical-model-operations.md`
