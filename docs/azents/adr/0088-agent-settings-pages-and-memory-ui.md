---
title: "ADR-0088: Agent Settings Pages and Memory UI"
created: 2026-07-02
tags: [frontend, api, memory, agent]
---

# ADR-0088: Agent Settings Pages and Memory UI
...
### ADR-0088-D1. Agent settings becomes a page hub with dedicated subpages
...
### ADR-0088-D2. Memory UI is a settings subpage, not a session tab
...
### ADR-0088-D3. Memory UI access separates read and write by scope
...
### ADR-0088-D4. Human UI uses strict CRUD semantics
...
### ADR-0088-D5. Ship settings IA and Memory as stacked phases
...
### ADR-0088-D6. Memory revision and restore are out of scope
