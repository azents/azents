---
title: "Add GPT-aligned apply-patch alongside the existing edit tool"
created: 2026-07-20
tags: [architecture, backend, engine, runtime, tools, historical-reconstruction, migration]
...
# gpt-260720/ADR: Add GPT-aligned apply-patch alongside the existing edit tool
...
### gpt-260720/ADR-D1 — Model-specific editing tools
...
### gpt-260720/ADR-D2 — Preserve the existing `edit` contract
...
### gpt-260720/ADR-D3 — Base path and relative patch paths
...
### gpt-260720/ADR-D4 — Initial file operations
...
### gpt-260720/ADR-D5 — V4A subset and text representation
...
### gpt-260720/ADR-D6 — Exact and unique context matching
...
### gpt-260720/ADR-D7 — Eligible files and destructive defaults
...
### gpt-260720/ADR-D8 — Runtime Runner owns patch execution
...
### gpt-260720/ADR-D9 — Preflight and optimistic concurrency
...
### gpt-260720/ADR-D10 — Preserve committed changes after a partial failure
...
### gpt-260720/ADR-D11 — Tool results and retry diagnostics
...
### gpt-260720/ADR-D12 — Bounded resource use
...
### gpt-260720/ADR-D13 — Existing tool coexistence
...
### gpt-260720/ADR-D14 — Evaluation and rollout
...
- Historical source filename: `0172-gpt-apply-patch-alongside-existing-edit.md`
