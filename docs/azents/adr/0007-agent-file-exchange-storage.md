---
title: "ADR-0007: Adopt Agent File Exchange Storage Separate from Sandbox Workspace"
created: 2026-05-05
updated: 2026-05-05
tags: [architecture, backend, engine, api, infra, frontend]
---

# ADR-0007: Adopt Agent File Exchange Storage Separate from Sandbox Workspace
...
Accepted. The detailed design follows `docs/nointern/design/agent-file-exchange-storage.md`.
