---
title: "ADR-0089: Workspace Project Browser Surface"
created: 2026-07-03
tags: [architecture, frontend, workspace, product]
---

# ADR-0089: Workspace Project Browser Surface
...
ADR-0076 made Project registrations session-owned. ADR-0086 made new-session Project selection explicit: the selected Project chips are the exact `project_paths` used to create the new `AgentSession`, and session creation no longer copies hidden Projects from the team-primary session.
...
### ADR-0089-D1 — Projects are the default Workspace browser mode
...
### ADR-0089-D2 — All files remains as a secondary inspection mode
...
### ADR-0089-D3 — Project management belongs inside the Workspace surface
...
### ADR-0089-D4 — Project root actions are registry-scoped, not filesystem-destructive
...
### ADR-0089-D5 — Empty Projects is an explicit state
...
### ADR-0089-D6 — Legacy Projects route is normalized away
