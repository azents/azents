---
title: "Agent-Centric Navigation Redesign Discussion"
created: 2026-04-20
tags: [frontend, azents-web, navigation, UX, historical-reconstruction, migration]
document_role: primary
document_type: adr
snapshot_id: nav-260420
historical_reconstruction: true
migration_source: "docs/azents/adr/0009-agent-centric-nav.md"
---

# nav-260420/ADR: Agent-Centric Navigation Redesign — Discussion Record
...
- `python/apps/azents/src/azents/worker/adapters/slack.py:621-622, 697-698` (Slack "View in Web" button)
- `python/apps/azents/src/azents/worker/adapters/discord.py:495-496` (Discord "View in Web" button)
...
Write the design document (`docs/azents/design/agent-centric-nav.md`) and proceed with phased stacked PRs.

## Migration provenance

- Historical source filename: `0009-agent-centric-nav.md`
