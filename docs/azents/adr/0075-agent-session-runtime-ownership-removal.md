---
title: "ADR-0075: Remove AgentSession Runtime Ownership"
created: 2026-06-25
tags: [architecture, backend, engine, migration]
---

# ADR-0075: Remove AgentSession Runtime Ownership

## Context

ADR-0074 defines `AgentSession` and `AgentRuntime` as sibling models owned by `Agent`.
