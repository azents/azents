---
title: "User Input Boundary FilePart Materialization"
created: 2026-06-04
tags: [architecture, backend, frontend, engine, security, historical-reconstruction, migration]
...
---
# input-260604/ADR: User Input Boundary FilePart Materialization
...
[exchange-260531/ADR](./exchange-260531-exchange-uploads.md) decided to change Web upload to agent-scoped Exchange upload instead of session-scoped upload. [file-260601/ADR](./file-260601-file-media-resource-lifecycle.md) separated Attachment, Artifact, FilePart, and ModelFile lifecycles. However, current implementation mixes these boundaries again:
...
- Historical source filename: `0049-user-input-bound-filepart-materialization.md`
