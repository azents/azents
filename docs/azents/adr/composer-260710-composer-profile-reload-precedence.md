---
title: "Restore the Latest Composer Profile Intent on Reload"
created: 2026-07-10
tags: [architecture, chat, frontend, session, historical-reconstruction, migration]
...
# composer-260710/ADR: Restore the Latest Composer Profile Intent on Reload
...
Editing a historical message temporarily initializes the editor from that message's requested profile under [reexecution-260710/ADR](./reexecution-260710-reexecution-target-intent.md). Cancelling edit restores the normal Composer state determined by its current draft/latest-intent state rather than replacing it with the edited message profile.
...
- Historical source filename: `0113-composer-profile-reload-precedence.md`
