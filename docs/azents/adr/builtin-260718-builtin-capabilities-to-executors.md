---
title: "Resolve built-in capabilities to model-specific executors"
created: 2026-07-18
tags: [architecture, backend, engine, llm, tools, historical-reconstruction, migration]
...
# builtin-260718/ADR: Resolve built-in capabilities to model-specific executors
...
- Historical source filename: `0166-resolve-builtin-capabilities-to-model-specific-executors.md`
