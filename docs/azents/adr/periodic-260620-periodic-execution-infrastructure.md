---
title: "Periodic Execution Infrastructure"
created: 2026-06-20
...
# periodic-260620/ADR: Periodic Execution Infrastructure
...
This ADR defines a lightweight system periodic execution infrastructure. It is not the user/agent-facing scheduled task product described by [scheduled-260331/ADR](./scheduled-260331-scheduled-tasks.md). User-defined schedules, cron/timezone UX, notification delivery, and agent-created scheduled work remain separate product scope.

## Decision

### periodic-260620/ADR-D1. Introduce a separate scheduler role
...
### periodic-260620/ADR-D2. Separate scheduling from execution through a TaskExecutor interface
...
### periodic-260620/ADR-D3. Keep schedule definitions in code registry
...
### periodic-260620/ADR-D4. Store current scheduler state only
...
### periodic-260620/ADR-D5. Use Postgres row lease for concurrency control
...
### periodic-260620/ADR-D6. Use task-definition retry policy
...
### periodic-260620/ADR-D7. Provide manual trigger through CLI only
...
### periodic-260620/ADR-D8. Devserver runs scheduler by default
...
### periodic-260620/ADR-D9. Expose v1 observability through CLI, logs, and current state
...
### periodic-260620/ADR-D10. Use no-op heartbeat as first consumer
...
### periodic-260620/ADR-D11. Treat Temporal as a future executor candidate only
...
- [scheduled-260331/ADR: Scheduled Tasks Discussion](./scheduled-260331-scheduled-tasks.md)
- [catalog-260620/ADR: Model Catalog Projection and Sync](./catalog-260620-catalog-projection-sync.md)

## Migration provenance

- Historical source filename: `0068-periodic-execution-infrastructure.md`
