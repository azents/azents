---
title: "ADR-0037: Introduce system Docker Sandbox Provider"
created: 2026-05-23
tags: [architecture, backend, engine, testenv]
---

# ADR-0037: Introduce system Docker Sandbox Provider
...
Accepted. Detailed design follows `docs/nointern/design/system-docker-sandbox-provider.md`.
