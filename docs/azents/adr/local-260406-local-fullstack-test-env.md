---
title: "Full-Stack Local Test Environment — Discussion Record"
created: 2026-04-06
tags: [infra, backend, historical-reconstruction, migration]
...
# local-260406/ADR: Full-Stack Local Test Environment — Discussion Record

> 📌 **Related design document**: [local-260406-local-fullstack-test-env.md](../design/local-260406-local-fullstack-test-env.md)
>
...
- Historical source filename: `0017-local-fullstack-test-env.md`
