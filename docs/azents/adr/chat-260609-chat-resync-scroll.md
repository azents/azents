---
title: "Chat Session Resync Converges to History/Live State After Subscribe Ack"
created: 2026-06-09
tags: [architecture, frontend, chat, historical-reconstruction, migration]
document_role: primary
document_type: adr
snapshot_id: chat-260609
historical_reconstruction: true
migration_source: "docs/azents/adr/0053-chat-session-resync-scroll-state.md"
---

# chat-260609/ADR: Chat Session Resync Converges to History/Live State After Subscribe Ack
...
Chat protocol separates persisted canonical event history and non-durable live state according to [chat-260604/ADR](./chat-260604-chat-protocol-history-live.md). However, synchronization order when entering screen, refreshing, or returning from tab/mobile app inactive state, and rendering modes by scroll state, were not defined as normalized states.
...
- chat-260609/ADR-D1: New entry/refresh fetches REST history/live after session subscribe ack.
- chat-260609/ADR-D2: If user was at bottom before inactive, return to latest following state.
- chat-260609/ADR-D3: If user was in middle scroll before inactive, return to detached history browsing state.
- chat-260609/ADR-D4: Long-open visible screen performs subscription health check every 30 seconds before resync.
- chat-260609/ADR-D5: Chat screen state is represented as latest following and detached history browsing ADT.
...
- [live-260604/ADR: Live/history projection handoff and stream batching are handled at canonical event level](./live-260604-live-history-projection-handoff-and-stream-batching.md)

## Migration provenance

- Historical source filename: `0053-chat-session-resync-scroll-state.md`
