---
title: "ADR-0064: Provider-hosted web search runs through normalized capability and Agent opt-in"
created: 2026-06-17
tags: [architecture, backend, engine, frontend]
---

# ADR-0064: Provider-hosted web search runs through normalized capability and Agent opt-in
...
### ADR-0064-D1. Agent settings store only semantic capability id `web_search`
...
### ADR-0064-D2. Model capability means selectability; execution is Agent opt-in
...
### ADR-0064-D3. LiteLLM Responses lowerer creates both model kwargs and hosted tool request surface
...
### ADR-0064-D4. Provider-hosted web search results are stored as canonical provider tool events
...
### ADR-0064-D5. Gemini web search allows main Agent tool combination without forcing subagent
