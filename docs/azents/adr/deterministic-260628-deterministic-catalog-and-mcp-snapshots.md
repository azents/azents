---
title: "Deterministic Tool Catalog, MCP Tool Snapshots, and Stable Toolkit Prompts"
created: 2026-06-28
tags: [architecture, backend, engine, toolkit, mcp, llm, historical-reconstruction, migration]
...
---
# deterministic-260628/ADR: Deterministic Tool Catalog, MCP Tool Snapshots, and Stable Toolkit Prompts
...
### deterministic-260628/ADR-D1. Canonicalize provider-facing tool order
...
### deterministic-260628/ADR-D2. Keep MCP tool discovery off the run critical path
...
### deterministic-260628/ADR-D3. Store MCP tool snapshots in Azents Toolkit State
...
### deterministic-260628/ADR-D4. Use background refresh with atomic snapshot replacement
...
### deterministic-260628/ADR-D5. Do not expose MCP loading, retry, or status pseudo-tools
...
### deterministic-260628/ADR-D6. Keep Goal and Todo tools model-visible regardless of stored state
...
### deterministic-260628/ADR-D7. Sort provider-hosted tools when multiple hosted tools are present
...
### deterministic-260628/ADR-D8. Apply the snapshot lifecycle to all MCP-backed toolkits
...
### deterministic-260628/ADR-D9. Keep Toolkit prompts stable and avoid transient state injection
...
### deterministic-260628/ADR-D10. Return compact acknowledgements from state-update tools
...
### deterministic-260628/ADR-D11. Keep Memory prompt injection as designed
...
### deterministic-260628/ADR-D12. Treat configuration-derived Toolkit prompts as legitimate cache boundaries
...
### deterministic-260628/ADR-D14. Treat AGENTS.md as a `read` tool result appendix, not a Toolkit prompt
...
### deterministic-260628/ADR-D13. Remove legacy per-user GitHub PAT behavior outside this optimization scope
...
### deterministic-260628/ADR-D15. Expose GitHub installation snapshots before lazy MCP startup completes
...
- Historical source filename: `0085-deterministic-tool-catalog-and-mcp-snapshots.md`
