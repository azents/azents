---
title: "Move Memory Storage from Filesystem to PostgreSQL"
created: 2026-04-26
...
# memory-260426/ADR: Move Memory Storage from Filesystem to PostgreSQL
...
- Historical source filename: `0002-memory-filesystem-to-db.md`
