---
title: "OSS Admin Surface Authentication and Bootstrap"
created: 2026-07-13
tags: [architecture, frontend, backend, auth, admin, oss, security, historical-reconstruction, migration]
...
# oss-260713/ADR: OSS Admin Surface Authentication and Bootstrap
...
[signup-260617/ADR-D5](./signup-260617-signup-token-registration.md) placed first-owner bootstrap in the public product flow and created a first Workspace. That
...
This bootstrap decision supersedes only the first-owner bootstrap shape in [signup-260617/ADR-D5](./signup-260617-signup-token-registration.md). Signup-token
registration and Workspace invitation decisions in [signup-260617/ADR](./signup-260617-signup-token-registration.md) remain unchanged.
...
- Historical source filename: `0144-oss-admin-surface-auth-and-bootstrap.md`
