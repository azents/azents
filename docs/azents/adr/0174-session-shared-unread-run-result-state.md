---
title: "ADR-0174: Model Unread Run Results as Session-Shared State"
created: 2026-07-20
tags: [conversation, backend, frontend, ux]
---

# ADR-0174: Model Unread Run Results as Session-Shared State
