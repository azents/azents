---
title: "Model Session Operations as Turn Actions"
created: 2026-07-05
tags: [architecture, backend, frontend, session, workspace, git, historical-reconstruction, migration]
...
# action-260705/ADR: Model Session Operations as Turn Actions

## Context

[initialization-260703/ADR](./initialization-260703-initialization-lifecycle.md) introduced `SessionInitialization` as a one-to-one setup lifecycle for an
...
### action-260705/ADR-D1 — Action messages are operation identity
...
### action-260705/ADR-D2 — Add `create_git_worktree` as a TurnAction
...
### action-260705/ADR-D3 — Multiple operations are multiple ordered actions
...
### action-260705/ADR-D4 — New-session setup uses the same action model
...
### action-260705/ADR-D5 — Action execution progress is durable-event based
...
### action-260705/ADR-D6 — Failure stops ordered action execution until user decision
...
### action-260705/ADR-D7 — Project registry mutation is a context invalidation boundary
...
### action-260705/ADR-D8 — Clean migration, no compatibility layer
...
- Historical source filename: `0094-action-as-operation-turn-actions.md`
