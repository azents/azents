---
title: "Session Web Viewer Discussion — View Discord/Slack Sessions in Web UI"
created: 2026-04-16
tags: [backend, engine, frontend, api, historical-reconstruction, migration]
document_role: primary
document_type: adr
snapshot_id: web-260416
historical_reconstruction: true
migration_source: "docs/azents/adr/0025-session-web-viewer.md"
---

> 📌 **Related design document**: [web-260416-web-viewer.md](../design/web-260416-web-viewer.md)
>
> This document records design-stage discussion. See the linked document for the final design and implementation state.

# web-260416/ADR: Session Web Viewer — View Discord/Slack Sessions in Web UI
...
- Historical source filename: `0025-session-web-viewer.md`
