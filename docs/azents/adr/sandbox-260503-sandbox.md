---
title: "Adopt Agent-Centric Raw Sessions and Optional Dedicated Sandboxes"
created: 2026-05-03
...
# sandbox-260503/ADR: Adopt Agent-Centric Raw Sessions and Optional Dedicated Sandboxes
...
Accepted. The detailed design follows `docs/nointern/design/sandbox-260503-sandbox.md`.

## Migration provenance

- Historical source filename: `0006-agent-centric-session-sandbox.md`
