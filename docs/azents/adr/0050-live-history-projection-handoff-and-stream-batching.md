---
title: "ADR-0050: Define Chat Live/History Handoff and Streaming Partial Batching"
created: 2026-06-04
tags: [architecture, backend, frontend, chat, streaming]
---

# ADR-0050: Define Chat Live/History Handoff and Streaming Partial Batching

## Status

Accepted.

ADR-0047's canonical history/live protocol decision remains in effect. This ADR is a follow-up decision that fixes handoff defects and streaming partial storage/delivery bottlenecks found after implementation.
