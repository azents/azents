---
title: "Label-Based Model Targets"
created: 2026-07-09
tags: [architecture, agent, backend, frontend, historical-reconstruction, migration]
...
# label-260709/ADR: Label-Based Model Targets
...
- Historical source filename: `0100-label-based-model-targets.md`
