---
title: "Move Sandbox Scope from Agent to Session"
created: 2026-04-24
...
# sandbox-260424/ADR: Move Sandbox Scope from Agent to Session
...
For detailed implementation decisions (Discussion [#2971](https://github.com/azents/azents/discussions/2971), A-G), see the design document [sandbox-260424-sandbox.md](../design/sandbox-260424-sandbox.md).
...
- Historical source filename: `0001-per-session-sandbox.md`
