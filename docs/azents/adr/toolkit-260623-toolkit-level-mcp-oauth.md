---
title: "Replace MCP Per-User OAuth with Toolkit-Level OAuth Connections"
created: 2026-06-23
tags: [backend, engine, security, api, historical-reconstruction, migration]
...
# toolkit-260623/ADR: Replace MCP Per-User OAuth with Toolkit-Level OAuth Connections
...
### toolkit-260623/ADR-D1: Remove MCP per-user OAuth
...
### toolkit-260623/ADR-D2: Use `auth_type=oauth2` for toolkit-level MCP OAuth
...
### toolkit-260623/ADR-D3: Store OAuth client/token state in `mcp_oauth_connections`
...
### toolkit-260623/ADR-D4: Use manager-only OAuth connect/exchange/disconnect APIs
...
### toolkit-260623/ADR-D5: Refresh OAuth tokens lazily under a row lock
...
### toolkit-260623/ADR-D6: Show OAuth connection status/actions without warning copy
...
- Historical source filename: `0071-toolkit-level-mcp-oauth.md`
