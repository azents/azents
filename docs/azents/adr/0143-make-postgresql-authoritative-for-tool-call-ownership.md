---
title: "ADR-0143: Make PostgreSQL Authoritative for Tool Call Ownership"
created: 2026-07-12
tags: [architecture, backend, engine, worker, reliability]
---

# ADR-0143: Make PostgreSQL Authoritative for Tool Call Ownership
