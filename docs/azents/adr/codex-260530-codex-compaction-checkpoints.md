---
title: "Generate Compaction Summary as Codex-like Handoff Checkpoint"
created: 2026-05-30
...
# codex-260530/ADR: Generate Compaction Summary as Codex-like Handoff Checkpoint
...
Azents canonical runtime replaces old model input with `compaction_summary` in long-running sessions. After [compaction-260530/ADR](./compaction-260530-compaction-logical-event-ordering.md), auto compaction preserves tail as raw events, and summary replaces only the compacted range.
...
- Historical source filename: `0043-codex-like-compaction-checkpoints.md`
