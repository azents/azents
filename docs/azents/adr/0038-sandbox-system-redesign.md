---
title: "ADR-0038: Sandbox System Redesign"
created: 2026-05-25
...
Accepted. This ADR records the decision that legacy Sandbox system must be replaced by Agent Runtime system. Later implementation details are recorded in `docs/azents/design/agent-runtime-system-redesign.md` and current behavior is defined by Living Specs.
...
- Related follow-up design: `docs/azents/design/agent-runtime-system-redesign.md`
