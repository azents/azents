---
title: "Session Initialization Lifecycle"
created: 2026-07-03
tags: [architecture, backend, frontend, session, historical-reconstruction, migration]
...
# initialization-260703/ADR: Session Initialization Lifecycle
...
### initialization-260703/ADR-D1 — Introduce one durable initialization lifecycle per AgentSession
...
### initialization-260703/ADR-D2 — Model initialization as typed internal steps
...
### initialization-260703/ADR-D3 — Gate run dispatch before input-buffer promotion
...
### initialization-260703/ADR-D4 — Use existing chat live transport with a new initialization taxonomy
...
### initialization-260703/ADR-D5 — Backend owns orchestration; runner owns filesystem/command execution
...
### initialization-260703/ADR-D6 — Retry and cleanup are explicit lifecycle actions
...
### initialization-260703/ADR-D7 — Retry requests run through the session broker ownership path
...
### initialization-260703/ADR-D8 — Initialization UI uses compact live state plus durable detail logs
...
### initialization-260703/ADR-D9 — Title generation waits for initialization readiness
...
### initialization-260703/ADR-D10 — AgentSessions have a durable human-readable handle
...
- Historical source filename: `0091-session-initialization-lifecycle.md`
