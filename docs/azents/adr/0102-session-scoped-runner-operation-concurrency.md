---
title: "ADR-0102: Session-Scoped Runner Operation Concurrency"
created: 2026-07-10
tags: [architecture, backend, runtime, performance]
---
# ADR-0102: Session-Scoped Runner Operation Concurrency
...
### ADR-0102-D1. Apply a per-Session limit of 10 and a Runtime-wide limit of 50
...
### ADR-0102-D2. Schedule eligible Session queues in round-robin order
...
### ADR-0102-D3. Use a bounded system queue for operations without a Session owner
...
### ADR-0102-D4. Share one Session limit across ordinary operation types
...
### ADR-0102-D5. Keep termination and cleanup available outside normal operation capacity
...
### ADR-0102-D6. Bound pending queues and fail admission explicitly
...
### ADR-0102-D7. Propagate ownership across foreground and background operations
...
### ADR-0102-D8. Make limits configurable and observable
...
### ADR-0102-D9. Use a coordinated internal protocol transition
...
### ADR-0102-D10. Verify fairness and saturation behavior
