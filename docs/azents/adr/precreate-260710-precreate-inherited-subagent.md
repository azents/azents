---
title: "Precreate the Inherited First Subagent Run"
created: 2026-07-10
tags: [architecture, backend, engine, subagent, historical-reconstruction, migration]
...
# precreate-260710/ADR: Precreate the Inherited First Subagent Run
...
[provenance-260710/ADR](./provenance-260710-inference-provenance.md) establishes AgentRun as the durable owner of requested and resolved execution provenance. The child first run is already known when `spawn_agent` executes inside the parent run.
...
- Historical source filename: `0119-precreate-inherited-subagent-run.md`
