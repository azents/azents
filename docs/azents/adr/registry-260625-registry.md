---
title: "Session-Owned Project Registry"
created: 2026-06-25
...
# registry-260625/ADR: Session-Owned Project Registry

## Context

[primary-260625/ADR](./primary-260625-primary-sessions.md) defines project registrations as `AgentSession` working context, while
...
- Historical source filename: `0076-session-owned-project-registry.md`
