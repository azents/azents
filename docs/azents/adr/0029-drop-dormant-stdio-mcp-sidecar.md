---
title: "ADR-0029: Remove Dormant stdio MCP Sidecar"
created: 2026-05-12
tags: [architecture, engine, infra]
---

# ADR-0029: Remove Dormant stdio MCP Sidecar

> 📌 **Related design document**: [drop-dormant-stdio-mcp-sidecar.md](../design/drop-dormant-stdio-mcp-sidecar.md)
...
4. **Clean up documentation contract**
   - Preserve historical document ADR-0018 unchanged.
