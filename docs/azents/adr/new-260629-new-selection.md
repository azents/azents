---
title: "New Session Project Selection"
created: 2026-06-29
tags: [architecture, product, backend, frontend, historical-reconstruction, migration]
...
# new-260629/ADR: New Session Project Selection
...
This ADR refines [primary-260625/ADR](./primary-260625-primary-sessions.md) and [registry-260625/ADR](./registry-260625-registry.md) for the first explicit Project-selection step. It does not decide git clone, worktree, Project source, Project trust, or Project-local config behavior.

## Decision

### new-260629/ADR-D1 — New-session Project chips are the exact Project set
...
### new-260629/ADR-D2 — Session creation APIs require `project_paths`
...
### new-260629/ADR-D3 — New-session defaults come from the latest non-primary session
...
### new-260629/ADR-D4 — Agent-owned Project Catalog is a preset store only
...
### new-260629/ADR-D5 — Catalog is populated by Project usage
...
### new-260629/ADR-D6 — Session Project rows remain path-only bindings
...
### new-260629/ADR-D7 — Nested and overlapping Project paths are allowed
...
### new-260629/ADR-D8 — Direct selection uses a dedicated directory picker
...
### new-260629/ADR-D9 — Session creation performs registry-level path validation only
...
- Historical source filename: `0086-new-session-project-selection.md`
