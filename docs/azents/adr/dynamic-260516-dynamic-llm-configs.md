---
title: "Move Agent Model Selection to Dynamic ModelConfig Structure"
created: 2026-05-16
...
# dynamic-260516/ADR: Move Agent Model Selection to Dynamic ModelConfig Structure
...
### 1. Keep [llm-260513/ADR](./llm-260513-llm-catalog-source.md) external catalog sync structure
...
- Historical source filename: `0031-dynamic-llm-model-configs.md`
