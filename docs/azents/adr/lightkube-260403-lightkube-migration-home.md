---
title: "Agent Home kubernetes_asyncio → lightkube Migration Discussion"
created: 2026-04-03
tags: [backend, kubernetes, sandbox, historical-reconstruction, migration]
document_role: primary
document_type: adr
snapshot_id: lightkube-260403
historical_reconstruction: true
migration_source: "docs/azents/adr/0015-lightkube-migration-agent-home.md"
---

# lightkube-260403/ADR: Agent Home kubernetes_asyncio → lightkube Migration Discussion

> 📌 **Related design document**: [lightkube-260403-lightkube-migration-home.md](../design/lightkube-260403-lightkube-migration-home.md)
...
- Historical source filename: `0015-lightkube-migration-agent-home.md`
