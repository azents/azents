---
title: "Add Session Sandbox Workspace Browser API"
created: 2026-05-01
tags: [architecture, backend, frontend, api, historical-reconstruction, migration]
...
# browser-260501/ADR: Add Session Sandbox Workspace Browser API
...
- Design document: [`../design/browser-260501-browser-api.md`](../design/browser-260501-browser-api.md)
...
- Historical source filename: `0005-workspace-browser-api.md`
