---
title: "Use Handoff Resume Wrapper When Injecting Compaction Summary"
created: 2026-05-31
...
# compaction-260531/ADR: Use Handoff Resume Wrapper When Injecting Compaction Summary
...
[codex-260530/ADR](./codex-260530-codex-compaction-checkpoints.md) decided to generate compaction summaries as Codex-like handoff checkpoints. However, even if the summary generation prompt improves, if the generated summary is injected into the next model input as a raw user message, the next agent can interpret it as ordinary conversation content or as a message to confirm.
...
- Historical source filename: `0044-compaction-summary-injection-wrapper.md`
