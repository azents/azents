---
title: "Add OpenRouter as an Integration-Scoped LLM Provider"
created: 2026-07-19
tags: [architecture, backend, frontend, engine, llm, security, historical-reconstruction, migration]
...
# openrouter-260719/ADR: Add OpenRouter as an Integration-Scoped LLM Provider
...
### openrouter-260719/ADR-D1. Expose all account-available text-output models without an Azents allowlist
...
### openrouter-260719/ADR-D2. Delegate upstream routing and data policy to OpenRouter account controls in the first release
...
### openrouter-260719/ADR-D3. Project OpenRouter account metadata directly with a neutral unknown-publisher classification
...
### openrouter-260719/ADR-D4. Reuse LiteLLM Responses with OpenRouter-owned wire semantics
...
### openrouter-260719/ADR-D5. Reuse the existing integration-catalog lifecycle and verify product behavior E2E-first
...
- [llm-260513/ADR: Move LLM Model Catalog to External Sources and Local Overrides](./llm-260513-llm-catalog-source.md)
- [catalog-260620/ADR: Model Catalog Projection and Sync](./catalog-260620-catalog-projection-sync.md)
- [failures-260718/ADR: Make Model Provider Failures Transparent](./failures-260718-failures-transparent.md)
- [builtin-260718/ADR: Resolve built-in capabilities to model-specific executors](./builtin-260718-builtin-capabilities-to-executors.md)
- [semantic-260718/ADR: Normalize Provider Tool Semantic Transcript Content](./semantic-260718-semantic-transcript.md)

## Migration provenance

- Historical source filename: `0169-add-openrouter-as-an-integration-scoped-llm-provider.md`
