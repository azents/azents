...
created: 2026-07-16
tags: [architecture, backend, frontend, engine, models, historical-reconstruction, migration]
...
# selectable-260716/ADR: Model-Scoped Selectable Model Settings
...
- Historical source filename: `0145-model-scoped-selectable-model-settings.md`
