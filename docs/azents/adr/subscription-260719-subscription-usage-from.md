---
title: "Project Subscription Usage from the Selected Composer Model"
created: 2026-07-19
tags: [architecture, frontend, llm, oauth, billing, security, ux, historical-reconstruction, migration]
...
# subscription-260719/ADR: Project Subscription Usage from the Selected Composer Model
...
### subscription-260719/ADR-D1. Project usage from the currently selected composer model
...
### subscription-260719/ADR-D2. Place the compact affordance beside the composer model selector
...
### subscription-260719/ADR-D3. Put operational details inside the model picker
...
### subscription-260719/ADR-D4. Keep financial details in LLM Settings
...
### subscription-260719/ADR-D5. Reuse the integration endpoint and client freshness policy
...
### subscription-260719/ADR-D6. Use severity only as presentation guidance
...
- [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-140) remains authoritative for integration-scoped usage, provider adapters, permissions, and the canonical LLM Settings surface. This ADR extends [ambiguous historical ADR reference](../notes/legacy-docid-migration-ambiguity-manifest-2026-07-21.md#ambiguity-ref-141) with a contextual session projection.
- [context-260710/ADR](./context-260710-context-usage-display.md) remains authoritative for run-scoped context usage in the session header.
- [prompt-260710/ADR](./prompt-260710-prompt-fifo-boundaries.md) and [boundaries-260710/ADR](./boundaries-260710-prompt-reasoning-effort-boundaries.md) remain authoritative for per-prompt model and reasoning-effort selection in the composer.

## Migration provenance

- Historical source filename: `0170-project-subscription-usage-from-selected-model.md`
