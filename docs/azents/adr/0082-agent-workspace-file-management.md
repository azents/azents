---
title: "ADR-0082: Add Agent Workspace File Management Operations"
created: 2026-06-28
tags: [backend, frontend, api, engine]
---

# ADR-0082: Add Agent Workspace File Management Operations
...
### ADR-0082-D1 — Use native Runner file management operations
...
### ADR-0082-D2 — Keep root confinement in the Agent Workspace service layer
...
### ADR-0082-D3 — Model rename as move
...
### ADR-0082-D4 — Expose inspector through stat metadata
...
### ADR-0082-D5 — Use conservative destructive defaults
