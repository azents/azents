---
title: "Remove Percentage Rollout from Apply-Patch Custom Selection"
created: 2026-07-21
...
# custom-260721/ADR: Remove Percentage Rollout from Apply-Patch Custom Selection

## Context

[patch-260721/ADR](./patch-260721-patch-dialects.md) introduced a provider-specific plaintext-custom transport for the logical
...
Supersede [patch-260721/ADR-D5](./patch-260721-patch-dialects.md) and [patch-260721/ADR-D6](./patch-260721-patch-dialects.md) only with respect to percentage rollout and
cohort selection:
...
- The immutable [patch-260721/ADR](./patch-260721-patch-dialects.md) and its implementation audit remain historical records. Current
  behavior is defined by this ADR and the living specs.

## Migration provenance

- Historical source filename: `0180-remove-apply-patch-custom-rollout.md`
