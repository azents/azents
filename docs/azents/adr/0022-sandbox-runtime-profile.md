---
title: "ADR-0022: Sandbox Runtime Profile Abstraction Discussion"
created: 2026-04-19
tags: [backend, sandbox, runtime, gvisor, kata]
---

# ADR-0022: Sandbox Runtime Profile Abstraction Discussion
...
- `docs/nointern/adr/0014-gvisor-byoc-sandbox.md` — background for gVisor adoption
