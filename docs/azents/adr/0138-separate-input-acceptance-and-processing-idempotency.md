---
title: "ADR-0138: Separate Input Acceptance and Processing Idempotency"
created: 2026-07-12
tags: [architecture, api, backend, database, idempotency]
---

# ADR-0138: Separate Input Acceptance and Processing Idempotency
...
Edit uses the same REST acceptance mechanism but follows ADR-0127 and directly commits its durable replacement event rather than creating a buffer.
...
- [ADR-0136: Use Polymorphic Input Buffer Processors](./0136-use-polymorphic-input-buffer-processors.md)
- [ADR-0137: Linearize Input Buffer Boundaries on the Session Row Lock](./0137-linearize-input-buffer-boundaries-on-session-row-lock.md)
