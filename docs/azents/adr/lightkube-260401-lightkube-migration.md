---
title: "kubernetes_asyncio → lightkube Migration Discussion"
created: 2026-04-01
tags: [backend, kubernetes, engine, historical-reconstruction, migration]
...
# lightkube-260401/ADR: kubernetes_asyncio → lightkube Migration Discussion
...
- Historical source filename: `0016-lightkube-migration.md`
