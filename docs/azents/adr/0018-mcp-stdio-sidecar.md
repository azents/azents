---
title: "ADR-0018: Agent Home Sidecar Discussion (MCP stdio + File ops)"
created: 2026-03-25
tags: [architecture, engine, infra]
---

# ADR-0018: Agent Home Sidecar Design

> 📌 **Related**: [mcp-stdio-toolkit.md](../design/mcp-stdio-toolkit.md)
...
> - [MCP stdio toolkit design](../design/mcp-stdio-toolkit.md) — stdio MCP sidecar, second implementation
>
