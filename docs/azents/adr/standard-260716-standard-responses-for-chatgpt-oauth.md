---
title: "Use Standard Responses for ChatGPT OAuth"
created: 2026-07-16
tags: [architecture, backend, engine, llm, openai, oauth, transport, tools, historical-reconstruction, migration]
...
# standard-260716/ADR: Use Standard Responses for ChatGPT OAuth
...
This decision supersedes only the Responses Lite dialect portions of [chatgpt-260716/ADR](./chatgpt-260716-chatgpt-oauth-in-openai-http-migration.md). [chatgpt-260716/ADR](./chatgpt-260716-chatgpt-oauth-in-openai-http-migration.md)'s OpenAI-native transport ownership and stateless ChatGPT storage semantics remain in force.
...
- Historical source filename: `0162-use-standard-responses-for-chatgpt-oauth.md`
