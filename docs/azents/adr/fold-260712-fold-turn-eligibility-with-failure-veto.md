---
title: "Fold Turn Eligibility with Failure Veto"
created: 2026-07-12
...
# fold-260712/ADR: Fold Turn Eligibility with Failure Veto
...
This decision retains [consume-260712/ADR](./consume-260712-consume-failed-buffer-items-without-starting-a-turn.md)'s final-failure behavior while qualifying the statement that any eligible buffer item is sufficient: an eligible result starts a turn only when no later handled failure veto remains in the FIFO fold.
...
- Historical source filename: `0133-fold-turn-eligibility-with-failure-veto.md`
