---
title: "ADR-0151: Use Generic Native Adapter Request Types"
created: 2026-07-16
tags: [architecture, backend, engine, llm, openai, typing]
---

# ADR-0151: Use Generic Native Adapter Request Types
...
ADR-0039 designed the model adapter boundary as generic over each adapter's native request and stream event types:
