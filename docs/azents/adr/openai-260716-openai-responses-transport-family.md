---
title: "Use an OpenAI-Native Responses Transport Family"
created: 2026-07-16
tags: [architecture, backend, engine, llm, openai, transport, historical-reconstruction, migration]
...
# openai-260716/ADR: Use an OpenAI-Native Responses Transport Family
...
- Historical source filename: `0147-openai-native-responses-transport-family.md`
