---
title: "ADR-0047: Chat Protocol Uses Canonical Event History/Live API"
created: 2026-06-04
tags: [architecture, backend, frontend, engine, chat]
---

# ADR-0047: Chat Protocol Uses Canonical Event History/Live API
...
- [Chat canonical event history/live API design](../design/chat-live-state-projection.md)
- `docs/azents/adr/0003-events-table-as-single-truth.md`
- `docs/azents/adr/0039-agent-execution-transcript-normalization.md`
- `docs/azents/adr/0042-compaction-logical-event-ordering.md`
