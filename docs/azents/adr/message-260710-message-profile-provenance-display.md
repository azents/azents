---
title: "Display Inference Provenance from User Message Metadata"
created: 2026-07-10
tags: [architecture, chat, frontend, observability, historical-reconstruction, migration]
...
# message-260710/ADR: Display Inference Provenance from User Message Metadata
...
- Historical source filename: `0112-user-message-profile-provenance-display.md`
