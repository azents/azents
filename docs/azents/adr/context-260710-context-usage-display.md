---
title: "Display Context Usage from the Resolved Run Profile"
created: 2026-07-10
...
# context-260710/ADR: Display Context Usage from the Resolved Run Profile
...
- Historical source filename: `0114-run-scoped-context-usage-display.md`
