---
title: "New signup is controlled by email-bound signup token redeem"
created: 2026-06-17
...
# signup-260617/ADR: New signup is controlled by email-bound signup token redeem
...
### signup-260617/ADR-D1. Main domain object of signup authority is signup token
...
### signup-260617/ADR-D2. Existing email OTP based new signup migrates to email-bound signup token redeem
...
### signup-260617/ADR-D3. Signup token is always email-bound and successful redeem treats that email as verified
...
### signup-260617/ADR-D4. Workspace invitation remains email-bound membership intent
...
### signup-260617/ADR-D5. First owner bootstrap is separate flow from signup token
...
- Historical source filename: `0065-signup-token-registration.md`
