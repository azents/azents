...
- **2026-07-19** (spec_version 108) — Added Agent-level default-disabled Tool Search; the enabled path applies provider-budgeted prepared-call projection, immutable catalog/search/executor snapshots, next-call activation, and deferred recency refresh.
