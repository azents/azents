...
- [Toolkit assignment design](../design/toolkit-assignment.md) — existing Toolkit 3-layer structure
- [LLM Provider Integration design](../design/llm-provider-integration.md) — encryption pattern reference
