...
tags: [backend, engine, documentation, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: toolkit-260514
migration_source: "docs/azents/design/toolkit-hooks-agents-md.md"
...
- [toolkit-260514/ADR: Adopt Toolkit Hooks and Toolkit State](../adr/toolkit-260514-toolkit-hooks-for-agents-md.md)
