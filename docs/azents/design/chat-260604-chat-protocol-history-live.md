...
tags: [architecture, backend, frontend, engine, api, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: chat-260604
migration_source: "docs/azents/design/chat-live-state-projection.md"
...
This design was written by re-reviewing the draft from PR #4390. It preserves [chat-260604/ADR](../adr/chat-260604-chat-protocol-history-live.md)'s decision to "separate history and live state", but does not adopt bespoke live schema. Contract is canonical event.
...
- [chat-260604/ADR](../adr/chat-260604-chat-protocol-history-live.md)'s history/live split decision is preserved in the new canonical event API direction.
