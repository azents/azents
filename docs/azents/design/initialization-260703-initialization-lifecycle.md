...
created: 2026-07-03
tags: [backend, engine, frontend, architecture, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: initialization-260703
migration_source: "docs/azents/design/session-initialization-steps.md"
...
- Resolved: [initialization-260703/ADR](../adr/initialization-260703-initialization-lifecycle.md) records the durable initialization table/status contract, run dispatch gate, live taxonomy, and session handle policy.
...
- Resolved: [initialization-260703/ADR](../adr/initialization-260703-initialization-lifecycle.md) records the persistent initialization lifecycle contract before implementation.
