...
created: 2026-06-23
updated: 2026-06-23
tags: [backend, engine, security, api, frontend]
---
...
Rejected by ADR-0071-D1. It preserves the complexity the feature aims to remove.

### Store tokens in `ToolkitConfig.encrypted_credentials`

Rejected by ADR-0071-D3. A dedicated connection row better supports locking and status.
...
Rejected by ADR-0071-D5. Lazy refresh is simpler and sufficient.

### OAuth warning copy in UI

Rejected by ADR-0071-D6. Status/actions are shown without warning copy.
