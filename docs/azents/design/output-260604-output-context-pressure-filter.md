...
tags: [backend, engine, runtime, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: output-260604
migration_source: "docs/azents/design/tool-output-context-pressure-filter.md"
historical_reconstruction: true
---
# Tool Output Context-Pressure Filter Design

Related decision record: [output-260604/ADR: Adopt tool output context-pressure filter](../adr/output-260604-output-context-pressure-filter.md)
