...
snapshot_id: discord-260312
migration_source: "docs/azents/design/discord-toolkit.md"
...
- [Slack Toolkit design](./slack-260312-slack-toolkit.md) — prior implementation with same pattern
- [Toolkit assignment design](./toolkit-260225-toolkit-assignment.md) — existing Toolkit 3-layer structure
