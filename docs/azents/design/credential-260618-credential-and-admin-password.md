...
migration_source: "docs/azents/design/credential-password-reset.md"
...
- Related decisions: [credential-260618/ADR-D1](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D2](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D3](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D4](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D5](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D6](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D6](../adr/credential-260618-credential-and-admin-password.md), [credential-260618/ADR-D7](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
- Related decisions: [credential-260618/ADR-D7](../adr/credential-260618-credential-and-admin-password.md)
- Acceptance criteria:
...
|---|---|
| [credential-260618/ADR-D1](../adr/credential-260618-credential-and-admin-password.md) | REQ-1 |
| [credential-260618/ADR-D2](../adr/credential-260618-credential-and-admin-password.md) | REQ-2 |
| [credential-260618/ADR-D3](../adr/credential-260618-credential-and-admin-password.md) | REQ-3 |
| [credential-260618/ADR-D4](../adr/credential-260618-credential-and-admin-password.md) | REQ-4 |
| [credential-260618/ADR-D5](../adr/credential-260618-credential-and-admin-password.md) | REQ-5 |
| [credential-260618/ADR-D6](../adr/credential-260618-credential-and-admin-password.md) | REQ-6, REQ-7 |
| [credential-260618/ADR-D7](../adr/credential-260618-credential-and-admin-password.md) | REQ-7, REQ-8 |
...
Decision: introduce CredentialProvider boundary from beginning. This decision is recorded in [credential-260618/ADR-D1](../adr/credential-260618-credential-and-admin-password.md).
...
Decision: make internal summary rich and use API-specific projection. This decision is recorded in [credential-260618/ADR-D2](../adr/credential-260618-credential-and-admin-password.md).
...
Decision: keep user_id-bound. Do not store email snapshot. This decision is recorded in [credential-260618/ADR-D6](../adr/credential-260618-credential-and-admin-password.md).
...
Decision: allow SMTP disabled state, represent recovery-required state, and recover with admin reset token. This decision is recorded in [credential-260618/ADR-D5](../adr/credential-260618-credential-and-admin-password.md).
