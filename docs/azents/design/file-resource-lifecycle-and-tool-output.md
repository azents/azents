...
This design expands ADR-0046 decisions into implementable units. Goal is to separate user-facing file delivery, agent/tool file outputs, and LLM rich input files, while organizing tool result schema into Responses `function_call_output` family.
