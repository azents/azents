...
- [Agent Sandbox design](./sandbox-260225-sandbox.md) — Sandbox isolation, network security, domain filtering
- [Toolkit assignment design](./toolkit-260225-toolkit-assignment.md) — Toolkit domain model, permissions, scope
