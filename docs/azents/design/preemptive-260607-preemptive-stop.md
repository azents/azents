...
tags: [architecture, backend, engine, worker, runtime, reliability, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: preemptive-260607
migration_source: "docs/azents/design/deterministic-tool-call-handling.md"
...
- Change user-stop semantics from [preemptive-260607/ADR](../adr/preemptive-260607-preemptive-stop.md). User stop remains a terminal run interruption; shutdown and handover remain non-terminal recovery boundaries.
...
[preemptive-260607/ADR](../adr/preemptive-260607-preemptive-stop.md) remains authoritative for explicit user stop:
...
| User stop during tool | Existing [preemptive-260607/ADR](../adr/preemptive-260607-preemptive-stop.md) interruption plus one cancelled result | History and run status |
