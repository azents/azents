---
title: "azents-web i18n Architecture"
created: 2026-02-16
updated: 2026-02-16
...
Azents `web` uses `[locale]` URL prefix, but azents-web is **cookie-based**:

| | Azents web | azents-web |
|--|-------------|-------------|
...
**Reason:** azents-web has a SPA-like structure and does not need localized URLs.
