...
tags: [backend, engine, api, frontend, historical-reconstruction]
created: 2026-03-15
updated: 2026-03-15
...
migration_source: "docs/azents/design/builtin-tools.md"
...
- [Built-in Tool discussion](../adr/builtin-260315-builtin-tools.md) — design decision process
- [ShellEnvironment design](./shell-260315-shell-environment.md) — shell_enabled, subagent Shell disable
