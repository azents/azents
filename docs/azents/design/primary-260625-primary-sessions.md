...
created: 2026-06-25
updated: 2026-06-25
tags: [architecture, backend, frontend, engine, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: primary-260625
migration_source: "docs/azents/design/primary-agent-sessions.md"
...
Related decisions: [primary-260625/ADR-D1](../adr/primary-260625-primary-sessions.md), [primary-260625/ADR-D7](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D2](../adr/primary-260625-primary-sessions.md), [primary-260625/ADR-D7](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D3](../adr/primary-260625-primary-sessions.md), [primary-260625/ADR-D4](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D4](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D5](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D6](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D8](../adr/primary-260625-primary-sessions.md), [primary-260625/ADR-D9](../adr/primary-260625-primary-sessions.md), [primary-260625/ADR-D10](../adr/primary-260625-primary-sessions.md)
...
Related decisions: [primary-260625/ADR-D11](../adr/primary-260625-primary-sessions.md)
...
|---|---|
| [primary-260625/ADR-D1](../adr/primary-260625-primary-sessions.md) Runtime and session are sibling models under Agent | REQ-1 |
| [primary-260625/ADR-D2](../adr/primary-260625-primary-sessions.md) Team primary session is the continuity-preserving default | REQ-2 |
| [primary-260625/ADR-D3](../adr/primary-260625-primary-sessions.md) Private sessions are target-compatible but implementation-deferred | REQ-3 |
| [primary-260625/ADR-D4](../adr/primary-260625-primary-sessions.md) Session list UX is divided into Team and Private sections | REQ-3, REQ-4 |
| [primary-260625/ADR-D5](../adr/primary-260625-primary-sessions.md) Selected Web session is route state | REQ-5 |
| [primary-260625/ADR-D6](../adr/primary-260625-primary-sessions.md) External routing defaults to primary sessions and hides arbitrary mappings | REQ-6 |
| [primary-260625/ADR-D7](../adr/primary-260625-primary-sessions.md) Primary session is not runtime current session | REQ-1, REQ-2 |
| [primary-260625/ADR-D8](../adr/primary-260625-primary-sessions.md) Projects are session-owned working context | REQ-7 |
| [primary-260625/ADR-D9](../adr/primary-260625-primary-sessions.md) New sessions copy projects from the team primary session | REQ-7 |
| [primary-260625/ADR-D10](../adr/primary-260625-primary-sessions.md) Git worktree automation is deferred | REQ-7 |
| [primary-260625/ADR-D11](../adr/primary-260625-primary-sessions.md) Primary clear behavior is deferred | REQ-8 |
...
Rejected by [primary-260625/ADR](../adr/primary-260625-primary-sessions.md). It breaks cross-channel continuity for workflows that move through Slack, GitHub, alerts, and Web UI.

### User-managed arbitrary channel/session mapping

Rejected by [primary-260625/ADR](../adr/primary-260625-primary-sessions.md). It makes users understand internal routing and session IDs.

### Runtime-owned current session

Rejected by [primary-260625/ADR](../adr/primary-260625-primary-sessions.md). It mixes product default conversation behavior with runtime infrastructure state.

### Runtime-owned project catalog or current project

Rejected by [primary-260625/ADR](../adr/primary-260625-primary-sessions.md). Projects are session working context, and runtime current project state would recreate hidden global selection state.
