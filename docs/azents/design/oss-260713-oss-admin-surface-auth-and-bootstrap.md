...
tags: [architecture, backend, frontend, auth, admin, security, oss, testenv, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: oss-260713
migration_source: "docs/azents/design/oss-admin-surface-auth-and-bootstrap.md"
...
[oss-260713/ADR](../adr/oss-260713-oss-admin-surface-auth-and-bootstrap.md).
