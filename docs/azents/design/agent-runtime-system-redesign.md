...
created: 2026-05-25
updated: 2026-05-25
tags: [architecture, backend, engine, infra, frontend, security]
---
...
Implemented. This document is a design record that translated agreements from [ADR-0038: Sandbox System Redesign](../adr/0038-sandbox-system-redesign.md) into Agent Runtime stacked PR implementation. Current system behavior should be verified against Living Specs, especially [Agent Runtime Control](../spec/flow/agent-runtime-control.md) and [Agent Runtime Persistence](../spec/flow/agent-runtime-persistence.md).
