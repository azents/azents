...
- **Phase 2**: access_token mode — stdio via mcp-proxy sidecar ([separate document](sentry-toolkit-stdio.md))
...
- details: [sentry-toolkit-stdio.md](sentry-toolkit-stdio.md)
