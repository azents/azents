...
tags: [frontend, llm, oauth, billing, security, ux, testing, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: subscription-260719
migration_source: "docs/azents/design/session-subscription-usage.md"
...
[subscription-260719/ADR](../adr/subscription-260719-subscription-usage-from.md) records the durable placement, ownership, and visibility decisions.
...
After validation and spec promotion, remove the temporary implementation plan. Keep this design as implementation rationale and [subscription-260719/ADR](../adr/subscription-260719-subscription-usage-from.md) as the durable decision record.
