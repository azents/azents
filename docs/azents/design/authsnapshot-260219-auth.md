...
- [Login guard design](./auth-260219-auth-guard.md) — protected page access control pattern
- [Unified email authentication design](./email-260217-email-login-onboarding.md) — backend API and full auth flow
- [azents web auth](./authsnapshot-260219-auth.md) — reference implementation (encrypted cookies + OAuth)
