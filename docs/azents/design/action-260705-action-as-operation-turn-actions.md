...
created: 2026-07-05
updated: 2026-07-05
tags: [backend, frontend, api, session, workspace, git, historical-reconstruction]
document_role: primary
document_type: design
snapshot_id: action-260705
migration_source: "docs/azents/design/existing-session-worktree-registration.md"
...
The backend operation model follows [action-260705/ADR](../adr/action-260705-action-as-operation-turn-actions.md). Creating the worktree is not a new public worktree
...
Rejected. [action-260705/ADR](../adr/action-260705-action-as-operation-turn-actions.md) established operation TurnActions as the session operation model. A separate
