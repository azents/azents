...
| --- | --- | --- | --- | --- | --- |
| Shared plan and composition | `/root` | this phase plan; `scheduler/registry.py`, `scheduler/registry_test.py`, `worker/deps.py`, shared composition-only edits | both implementation workstreams | registered bounded dispatcher and conflict-free DI composition | registry tests, import smoke, diff/scope audit |
