...
- Provider Deployment: `AZ_RUNTIME_PROVIDER_LEASE_NAMESPACE`, `AZ_RUNTIME_PROVIDER_WORKLOAD_NAMESPACE`, `AZ_RUNTIME_PROVIDER_WORKSPACE_PATH`, `AZ_RUNTIME_PROVIDER_STORAGE_CLASS`, `AZ_RUNTIME_PROVIDER_PVC_SIZE`, `AZ_RUNTIME_PROVIDER_NIX_STORE_STORAGE_CLASS`, `AZ_RUNTIME_PROVIDER_NIX_STORE_SIZE`, `AZ_RUNTIME_PROVIDER_POD_IMAGE_PULL_SECRETS`
